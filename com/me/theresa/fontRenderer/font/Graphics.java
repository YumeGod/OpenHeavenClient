...
import com.me.theresa.fontRenderer.font.AngelCodeFont;
import com.me.theresa.fontRenderer.font.Animation;
...
public class Graphics {
    ...
    private final DoubleBuffer worldClip = BufferUtils.createDoubleBuffer((int)4);
    private final ByteBuffer readBuffer = BufferUtils.createByteBuffer((int)4);
    ...
    public void fillRect(float x, float y, float width, float height, Image pattern, float offX, float offY) {
        ...
        Rectangle preClip = this.worldClipRecord;
