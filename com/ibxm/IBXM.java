...
import com.ibxm.Channel;
import com.ibxm.Module;
import com.ibxm.Pattern;

public class IBXM {
    public static final String VERSION = "com.ibxm alpha 51 (c)2008 mumart@gmail.com";
    ...
    private void set_tempo(int bpm) {
        if (bpm > 31 && bpm < 256) {
            this.tick_length_samples = this.sampling_rate * 5 / (bpm << 1);
        }
    }
    ...
    private void volume_ramp() {
        ...
        int ramp_end = (this.volume_ramp_length << 1) - 1;
    ...
    private void clear_vol_ramp_buffer() {
        int ramp_end = (this.volume_ramp_length << 1) - 1;
        for (int ramp_idx = 0; ramp_idx <= ramp_end; ++ramp_idx) {
