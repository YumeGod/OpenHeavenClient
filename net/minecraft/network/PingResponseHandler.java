            ...
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                switch (i) {
                    ...
                    default: {
                        ...
                        flag1 &= "MC|PingHost".equals(new String(bytebuf.readBytes(bytebuf.readShort() << 1).array(), Charsets.UTF_16BE));
                        int j = bytebuf.readUnsignedShort();
                        flag1 &= bytebuf.readUnsignedByte() >= 73;
                        flag1 &= 3 + bytebuf.readBytes(bytebuf.readShort() << 1).array().length + 4 == j;
