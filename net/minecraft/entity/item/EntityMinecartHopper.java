...
implements IHopper {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (!this.worldObj.isRemote && this.isEntityAlive() && this.isBlocked) {
            BlockPos blockpos = new BlockPos(this);
            this.transferTicker = blockpos.equals(this.field_174900_c) ? --this.transferTicker : 0;
            if (!this.canTransfer()) {
