...
implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            for (int l = 0; l < 4; ++l) {
                i = MathHelper.floor_double(this.posX + (double)((float)((l % 2 << 1) - 1) * 0.25f));
                BlockPos blockpos = new BlockPos(i, j = MathHelper.floor_double(this.posY), k = MathHelper.floor_double(this.posZ + (double)((float)((l / 2 % 2 << 1) - 1) * 0.25f)));
