...
extends EntityMob {
    ...
    static final AttributeModifier attackingSpeedBoostModifier = new AttributeModifier(attackingSpeedBoostModifierUUID, "Attacking speed boost", 0.15f, 0).setSaved(false);
    static final Set<Block> carriableBlocks = Sets.newIdentityHashSet();
    ...
    extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            BlockPos blockpos = new BlockPos(i, j = MathHelper.floor_double(this.enderman.posY + random.nextDouble() * 3.0), k = MathHelper.floor_double(this.enderman.posZ - 2.0 + random.nextDouble() * 4.0));
