...
extends EntityMinecart {
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.getDataWatcher().updateObject(23, this.commandBlockLogic.getCommand());
        this.getDataWatcher().updateObject(24, IChatComponent.Serializer.componentToJson(this.commandBlockLogic.getLastOutput()));
    }
    ...
    public void onActivatorRailPass(int x, int y, int z, boolean receivingPower) {
        if (receivingPower && this.ticksExisted - this.activatorRailCooldown >= 4) {
            this.commandBlockLogic.trigger(this.worldObj);
