...
implements IInvBasic {
    ...
    public int increaseTemper(int p_110198_1_) {
        int i;
        this.temper = i = MathHelper.clamp_int(this.temper + p_110198_1_, 0, this.getMaxTemper());
        return i;
    }
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setBoolean("HasReproduced", this.hasReproduced);
        ...
        tagCompound.setInteger("Temper", this.temper);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.hasReproduced = tagCompund.getBoolean("HasReproduced");
        this.setHorseType(tagCompund.getInteger("Type"));
        this.setHorseVariant(tagCompund.getInteger("Variant"));
        this.temper = tagCompund.getInteger("Temper");
