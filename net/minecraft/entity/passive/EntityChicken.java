...
extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        ...
        if (!(this.worldObj.isRemote || this.isChild() || this.chickenJockey || --this.timeUntilNextEgg > 0)) {
    ...
    protected int getExperiencePoints(EntityPlayer player) {
        return this.chickenJockey ? 10 : super.getExperiencePoints(player);
    }
    ...
    protected boolean canDespawn() {
        return this.chickenJockey && this.riddenByEntity == null;
    }
