...
public class EntityTrackerEntry {
    ...
    private Packet createSpawnPacket() {
        ...
        if (this.trackedEntity instanceof EntityItemFrame) {
            ...
            s0epacketspawnobject1.setX(MathHelper.floor_float(blockpos1.getX() << 5));
            s0epacketspawnobject1.setY(MathHelper.floor_float(blockpos1.getY() << 5));
            s0epacketspawnobject1.setZ(MathHelper.floor_float(blockpos1.getZ() << 5));
        ...
        if (this.trackedEntity instanceof EntityLeashKnot) {
            ...
            s0epacketspawnobject.setX(MathHelper.floor_float(blockpos.getX() << 5));
            s0epacketspawnobject.setY(MathHelper.floor_float(blockpos.getY() << 5));
            s0epacketspawnobject.setZ(MathHelper.floor_float(blockpos.getZ() << 5));
