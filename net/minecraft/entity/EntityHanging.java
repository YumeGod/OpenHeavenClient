...
extends Entity {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setInteger("TileX", this.hangingPosition.getX());
        tagCompound.setInteger("TileY", this.hangingPosition.getY());
        tagCompound.setInteger("TileZ", this.hangingPosition.getZ());
    }
