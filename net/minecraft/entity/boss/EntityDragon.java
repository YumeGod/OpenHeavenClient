...
IMob {
        ...
        if (this.getHealth() <= 0.0f) {
            ...
            if (this.isAIDisabled()) {
                ...
                for (int j = 0; j < 3; ++j) {
                    ...
                    double[] adouble2 = this.getMovementOffsets(12 + (j << 1), 1.0f);
                    ...
                    entitydragonpart.setLocationAndAngles(this.posX - (double)((f16 * f23 + f21 * f24) * f2), this.posY + (adouble2[1] - adouble1[1]) - (double)((f24 + f23) * f15) + 1.5, this.posZ + (double)((f4 * f23 + f22 * f24) * f2), 0.0f, 0.0f);
                }
                if (!this.worldObj.isRemote) {
    ...
    private void setNewTarget() {
        ...
        list.removeIf(entityPlayer -> entityPlayer.isSpectator());
