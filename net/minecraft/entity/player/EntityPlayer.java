...
extends EntityLivingBase {
    ...
    protected boolean isMovementBlocked() {
        return this.getHealth() <= 0.0f || this.sleeping;
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (this.sleeping && !this.worldObj.isRemote) {
            this.wakeUpPlayer(true, true, false);
        }
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        if (targetEntity.canAttackWithItem()) {
            if (targetEntity != Minecraft.thePlayer) {
                    ...
                    if (flag2) {
                        ...
                        if (i > 0) {
                            ...
                            if (Client.instance.getModuleManager().getModuleByClass(KillAura.class).isEnabled() && KillAura.target != null) {
                                this.motionX *= 0.6;
                                this.motionZ *= 0.6;
                                if (!Client.instance.getModuleManager().getModuleByClass(Sprint.class).isEnabled()) {
    ...
    public EnumStatus trySleep(BlockPos bedLocation) {
        if (!this.worldObj.isRemote) {
            if (this.sleeping || !this.isEntityAlive()) {
    ...
    public int xpBarCap() {
        return this.experienceLevel >= 30 ? 112 + (this.experienceLevel - 30) * 9 : (this.experienceLevel >= 15 ? 37 + (this.experienceLevel - 15) * 5 : 7 + (this.experienceLevel << 1));
    }
