...
public class ServerData {
    ...
    public static ServerData getServerDataFromNBTCompound(NBTTagCompound nbtCompound) {
        ...
        serverdata.resourceMode = nbtCompound.hasKey("acceptTextures", 1) ? (nbtCompound.getBoolean("acceptTextures") ? ServerResourceMode.ENABLED : ServerResourceMode.DISABLED) : ServerResourceMode.PROMPT;
        return serverdata;
    }
    ...
    public void copyFrom(ServerData serverDataIn) {
        ...
        this.resourceMode = serverDataIn.resourceMode;
