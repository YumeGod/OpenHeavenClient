...
extends GuiScreen {
    static final List<LayerItem> FLAT_WORLD_PRESETS = Lists.newArrayList();
    ...
    ListSlot field_146435_s;
    private GuiButton field_146434_t;
    GuiTextField field_146433_u;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiFlatPresets.drawString(this.fontRendererObj, this.presetsShare, 50, 30, 0xA0A0A0);
        GuiFlatPresets.drawString(this.fontRendererObj, this.field_146436_r, 50, 70, 0xA0A0A0);
    ...
    extends GuiSlot {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
            ...
            ListSlot listSlot = this;
            listSlot.mc.getTextureManager().bindTexture(Gui.statIcons);
            float f = 0.0078125f;
            float f1 = 0.0078125f;
            int i = 18;
            int j = 18;
