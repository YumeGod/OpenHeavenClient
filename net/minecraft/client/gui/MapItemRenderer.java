...
public class MapItemRenderer {
    static final ResourceLocation mapIcons = new ResourceLocation("textures/map/map_icons.png");
    ...
    class Instance {
        ...
        void updateMapTexture() {
            for (int i = 0; i < 16384; ++i) {
                ...
                this.mapTextureData[i] = j / 4 == 0 ? ((i + i / 128 & 1) << 3) + 16 << 24 : MapColor.mapColorArray[j / 4].getMapColor(j & 3);
            }
        ...
        void render(boolean noOverlayRendering) {
            ...
            worldrenderer.pos((float)i + f, (float)(j + 128) - f, -0.01f).tex(0.0, 1.0).endVertex();
            worldrenderer.pos((float)(i + 128) - f, (float)(j + 128) - f, -0.01f).tex(1.0, 1.0).endVertex();
            worldrenderer.pos((float)(i + 128) - f, (float)j + f, -0.01f).tex(1.0, 0.0).endVertex();
            worldrenderer.pos((float)i + f, (float)j + f, -0.01f).tex(0.0, 0.0).endVertex();
            tessellator.draw();
