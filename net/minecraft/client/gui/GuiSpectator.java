...
implements ISpectatorMenuRecipient {
    ...
    protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_) {
        ...
        GuiSpectator guiSpectator = this;
        guiSpectator.field_175268_g.getTextureManager().bindTexture(field_175267_f);
    ...
    private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_) {
        GuiSpectator guiSpectator = this;
        guiSpectator.field_175268_g.getTextureManager().bindTexture(field_175269_a);
        if (p_175266_5_ != SpectatorMenu.field_178657_a) {
            ...
            if (i > 3 && p_175266_5_.func_178662_A_()) {
                Minecraft.fontRendererObj.drawStringWithShadow(s, p_175266_2_ + 19 - 2 - Minecraft.fontRendererObj.getStringWidth(s), p_175266_3_ + 6.0f + 3.0f, 0xFFFFFF + (i << 24));
            }
        }
    }
    ...
    public void renderSelectedItem(ScaledResolution p_175263_1_) {
        ...
        if (i > 3 && this.field_175271_i != null) {
            ...
            if (s != null) {
                int j = (p_175263_1_.getScaledWidth() - Minecraft.fontRendererObj.getStringWidth(s)) / 2;
                int k = p_175263_1_.getScaledHeight() - 35;
                GlStateManager.pushMatrix();
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                Minecraft.fontRendererObj.drawStringWithShadow(s, j, k, 0xFFFFFF + (i << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
