...
GuiPageButtonList.GuiResponder {
    ...
    public void func_175324_a(String p_175324_1_) {
        this.field_175336_F = p_175324_1_ != null && !p_175324_1_.isEmpty() ? ChunkProviderSettings.Factory.jsonToFactory(p_175324_1_) : new ChunkProviderSettings.Factory();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            GuiCustomizeWorldScreen.drawVerticalLine(width / 2 - 91, 99, 185, -2039584);
            GuiCustomizeWorldScreen.drawVerticalLine(width / 2 + 90, 99, 185, -6250336);
            float f = 85.0f;
            float f1 = 180.0f;
            ...
            GuiCustomizeWorldScreen guiCustomizeWorldScreen = this;
            guiCustomizeWorldScreen.mc.getTextureManager().bindTexture(optionsBackground);
