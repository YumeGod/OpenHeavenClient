...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        ((GuiButton)this.buttonList.get((int)0)).enabled = !this.field_146302_g.getText().isEmpty() && this.field_146302_g.getText().split(":").length > 0;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenServerList.drawString(this.fontRendererObj, I18n.format("addServer.enterIp", new Object[0]), width / 2 - 100, 100, 0xA0A0A0);
