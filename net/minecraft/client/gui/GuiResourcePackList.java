...
extends GuiListExtended {
    ...
    protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
        ...
        Minecraft.fontRendererObj.drawString(s, p_148129_1_ + this.width / 2 - Minecraft.fontRendererObj.getStringWidth(s) / 2, Math.min(this.top + 3, p_148129_2_), 0xFFFFFF);
    }
    ...
    protected int getSize() {
        return this.field_148204_l.size();
    }

    @Override
    public ResourcePackListEntry getListEntry(int index) {
        return this.field_148204_l.get(index);
    }
