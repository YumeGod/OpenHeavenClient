...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        boolean bl = this.doneBtn.enabled = !this.commandTextField.getText().trim().isEmpty();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.command", new Object[0]), width / 2 - 150, 37, 0xA0A0A0);
        this.commandTextField.drawTextBox();
        int i = 75;
        int j = 0;
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 0xA0A0A0);
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 0xA0A0A0);
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 0xA0A0A0);
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 0xA0A0A0);
        GuiCommandBlock.drawString(this.fontRendererObj, "", width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 0xA0A0A0);
        if (!this.previousOutputTextField.getText().isEmpty()) {
            i = i + j * this.fontRendererObj.FONT_HEIGHT + 16;
            GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), width / 2 - 150, i, 0xA0A0A0);
