...
extends GuiContainer {
    ...
    static final ResourceLocation beaconGuiTextures = new ResourceLocation("textures/gui/container/beacon.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        GuiBeacon guiBeacon = this;
        guiBeacon.mc.getTextureManager().bindTexture(beaconGuiTextures);
