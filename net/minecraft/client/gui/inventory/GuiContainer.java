...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(6969, 3, 3, 110, 20, "Disable KillAura"));
        this.buttonList.add(new GuiButton(696969, 3, 25, 110, 20, "Disable TPAura"));
        this.buttonList.add(new GuiButton(69696969, 2, 46, 110, 20, "Disable InvManager"));
        this.buttonList.add(new GuiButton(696969969, 2, 67, 110, 20, "Disable ChestStealer"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.translate.interpolate(width, height, 0.3f);
        int i = this.guiLeft;
        int j = this.guiTop;
        double xmod = (float)(width / 2) - this.translate.getX() / 2.0f;
        double ymod = (float)(height / 2) - this.translate.getY() / 2.0f;
        if (Client.instance.getModuleManager().getModuleByClass(ContainerAnimations.class).isEnabled()) {
        ...
        if (Client.instance.getModuleManager().getModuleByClass(ContainerAnimations.class).isEnabled()) {
            GlStateManager.scale((float)width / this.translate.getX(), (float)height / this.translate.getY(), 1.0f);
            GlStateManager.translate(-xmod, -ymod, 0.0);
        }
    }
        ...
        if (slotIn == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && itemstack != null) {
            ...
            if (Container.canAddItemToSlot(slotIn, itemstack1, true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
                ...
                if (itemstack.stackSize > itemstack.getMaxStackSize()) {
                    s = (Object)((Object)EnumChatFormatting.YELLOW) + String.valueOf(itemstack.getMaxStackSize());
                    itemstack.stackSize = itemstack.getMaxStackSize();
                }
                if (itemstack.stackSize > slotIn.getItemStackLimit(itemstack)) {
                    s = (Object)((Object)EnumChatFormatting.YELLOW) + String.valueOf(slotIn.getItemStackLimit(itemstack));
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (Object aButtonList : this.buttonList) {
            ...
            if (var52.mousePressed(this.mc, mouseX, mouseY) && var52.id == 69696969) {
                Client.instance.getModuleManager().getModuleByClass(InvCleaner.class).setEnabled(false);
            }
            if (!var52.mousePressed(this.mc, mouseX, mouseY) || var52.id != 696969969) continue;
