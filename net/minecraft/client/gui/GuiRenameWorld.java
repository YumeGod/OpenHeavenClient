...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        boolean bl = ((GuiButton)this.buttonList.get((int)0)).enabled = !this.field_146583_f.getText().trim().isEmpty();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiRenameWorld.drawString(this.fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), width / 2 - 100, 47, 0xA0A0A0);
