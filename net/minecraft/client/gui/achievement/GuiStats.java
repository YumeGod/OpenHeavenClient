...
implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            GuiStats.drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], width / 2, height / 2 + (this.fontRendererObj.FONT_HEIGHT << 1), 0xFFFFFF);
        } else {
    ...
    void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
        ...
        GuiStats guiStats = this;
        guiStats.mc.getTextureManager().bindTexture(statIcons);
        float f = 0.0078125f;
        float f1 = 0.0078125f;
        int i = 18;
        int j = 18;
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 64, ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT << 2);
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_180791_2_ + 2 - 10, p_180791_3_ + 1, 0xFFFFFF);
            GuiStats.drawString(GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT, i == 0 ? 0x606060 : 0x909090);
            GuiStats.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + (((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT << 1), j == 0 ? 0x606060 : 0x909090);
        }
    }
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.drawString(GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 0xFFFFFF : 0x909090);
            String s = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
            GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_180791_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s), p_180791_3_ + 1, entryID % 2 == 0 ? 0xFFFFFF : 0x909090);
        }
    }
    ...
    extends GuiSlot {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                ...
                GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s), p_148209_3_ + 5, p_148209_4_ ? 0xFFFFFF : 0x909090);
            } else {
                String s1 = "-";
                GuiStats.drawString(GuiStats.this.fontRendererObj, s1, p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s1), p_148209_3_ + 5, p_148209_4_ ? 0xFFFFFF : 0x909090);
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s;
            String s1;
            if (p_148213_1_ != null && !(s1 = I18n.format((s = (itemstack = new ItemStack(item = p_148213_1_.func_150959_a())).getUnlocalizedName()) + ".name", new Object[0]).trim()).isEmpty()) {
