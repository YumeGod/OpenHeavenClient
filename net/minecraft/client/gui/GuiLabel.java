...
extends Gui {
    ...
    public void drawLabel(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            for (int k = 0; k < this.field_146173_k.size(); ++k) {
                ...
                GuiLabel.drawString(this.fontRenderer, this.field_146173_k.get(k), this.field_146162_g, j + k * 10, this.field_146168_n);
            }
        }
    }
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            int i = this.field_146167_a + (this.field_146163_s << 1);
            int j = this.field_146161_f + (this.field_146163_s << 1);
