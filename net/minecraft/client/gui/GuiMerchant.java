...
extends GuiContainer {
    ...
    static final ResourceLocation MERCHANT_GUI_TEXTURE = new ResourceLocation("textures/gui/container/villager.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        GuiMerchant guiMerchant = this;
        guiMerchant.mc.getTextureManager().bindTexture(MERCHANT_GUI_TEXTURE);
        int i = (width - this.xSize) / 2;
        int j = (height - this.ySize) / 2;
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
            ...
            if (merchantrecipe.isRecipeDisabled()) {
                GuiMerchant guiMerchant2 = this;
                guiMerchant2.mc.getTextureManager().bindTexture(MERCHANT_GUI_TEXTURE);
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
