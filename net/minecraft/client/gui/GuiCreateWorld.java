...
extends GuiScreen {
    ...
    public static String getUncollidingSaveDirName(ISaveFormat saveLoader, String name) {
        ...
        for (String s : disallowedFilenames) {
            if (!nameBuilder.toString().equalsIgnoreCase(s)) continue;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.inMoreWorldOptionsDisplay) {
            ...
            GuiCreateWorld.drawString(this.fontRendererObj, I18n.format("selectWorld.resultFolder", new Object[0]) + " " + this.saveDirName, width / 2 - 100, 85, -6250336);
            this.worldNameField.drawTextBox();
            GuiCreateWorld.drawString(this.fontRendererObj, this.gameModeDesc1, width / 2 - 100, 137, -6250336);
            GuiCreateWorld.drawString(this.fontRendererObj, this.gameModeDesc2, width / 2 - 100, 149, -6250336);
        }
