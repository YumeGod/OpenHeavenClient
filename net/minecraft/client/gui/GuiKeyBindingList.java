...
extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls controls, Minecraft mcIn) {
        ...
        for (KeyBinding keybinding : akeybinding) {
            ...
            if ((j = Minecraft.fontRendererObj.getStringWidth(I18n.format(keybinding.getKeyDescription(), new Object[0]))) > this.maxListLabelWidth) {
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            ...
            Minecraft cfr_ignored_0 = GuiKeyBindingList.this.mc;
            Minecraft cfr_ignored_1 = GuiKeyBindingList.this.mc;
            Minecraft.fontRendererObj.drawString(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - Minecraft.fontRendererObj.FONT_HEIGHT / 2, 0xFFFFFF);
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            Minecraft cfr_ignored_0 = GuiKeyBindingList.this.mc;
            GuiScreen cfr_ignored_1 = GuiKeyBindingList.this.mc.currentScreen;
            Minecraft cfr_ignored_2 = GuiKeyBindingList.this.mc;
            Minecraft.fontRendererObj.drawString(this.labelText, GuiScreen.width / 2 - this.labelWidth / 2, y + slotHeight - Minecraft.fontRendererObj.FONT_HEIGHT - 1, 0xFFFFFF);
        }
