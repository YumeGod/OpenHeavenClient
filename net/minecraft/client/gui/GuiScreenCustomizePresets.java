...
extends GuiScreen {
    static final List<Info> field_175310_f = Lists.newArrayList();
    ListPreset field_175311_g;
    private GuiButton field_175316_h;
    GuiTextField field_175317_i;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenCustomizePresets.drawString(this.fontRendererObj, this.field_175313_s, 50, 30, 0xA0A0A0);
        GuiScreenCustomizePresets.drawString(this.fontRendererObj, this.field_175312_t, 50, 70, 0xA0A0A0);
    ...
    extends GuiSlot {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
            ...
            ListPreset listPreset = this;
            listPreset.mc.getTextureManager().bindTexture(p_178051_3_);
            int j = 32;
            int k = 32;
            Tessellator tessellator = Tessellator.getInstance();
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
            worldrenderer.pos(i, p_178051_2_ + 32, 0.0).tex(0.0, 1.0).endVertex();
            worldrenderer.pos(i + 32, p_178051_2_ + 32, 0.0).tex(1.0, 1.0).endVertex();
            worldrenderer.pos(i + 32, p_178051_2_, 0.0).tex(1.0, 0.0).endVertex();
            worldrenderer.pos(i, p_178051_2_, 0.0).tex(0.0, 0.0).endVertex();
            tessellator.draw();
        }
