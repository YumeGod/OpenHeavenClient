...
extends GuiContainer {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; ++k) {
            ...
            if (!this.container.enchantItem(Minecraft.thePlayer, k)) continue;
            Minecraft.playerController.sendEnchantPacket(this.container.windowId, k);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        v0 = this;
        v0.mc.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_GUI_TEXTURE);
        ...
        v1 = this;
        v1.mc.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_BOOK_TEXTURE);
        GlStateManager.rotate(20.0f, 1.0f, 0.0f, 0.0f);
        f2 = this.field_147076_A + (this.field_147080_z - this.field_147076_A) * partialTicks;
        ...
        f3 = this.field_147069_w + (this.field_147071_v - this.field_147069_w) * partialTicks + 0.25f;
        f4 = this.field_147069_w + (this.field_147071_v - this.field_147069_w) * partialTicks + 0.75f;
        ...
        for (l = 0; l < 3; ++l) {
            block10: {
                ...
                j1 = i1 + 20;
                k1 = 86;
                s = EnchantmentNameParts.getInstance().generateNewRandomName();
                GuiEnchantment.zLevel = 0.0f;
                v2 = this;
                v2.mc.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_GUI_TEXTURE);
                l1 = this.container.enchantLevels[l];
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
                if (l1 == 0) {
                ...
                if (Minecraft.thePlayer.experienceLevel >= l1) ** GOTO lbl-1000
            }
