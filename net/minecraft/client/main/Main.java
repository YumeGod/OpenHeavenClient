...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo((Object)("YUXIANGLL" + Minecraft.getSystemTime() % 1000L), (Object[])new String[0]);
        ...
        ArgumentAcceptingOptionSpec optionspec13 = optionparser.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo((Object)1280, (Object[])new Integer[0]);
        ArgumentAcceptingOptionSpec optionspec14 = optionparser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo((Object)720, (Object[])new Integer[0]);
