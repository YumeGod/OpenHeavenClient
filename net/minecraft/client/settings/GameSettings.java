...
public class GameSettings {
    ...
    public void setOptionFloatValue(Options settingsOption, float value) {
        ...
        if (settingsOption == Options.MIPMAP_LEVELS) {
            ...
            if ((float)i != value) {
                ...
                gameSettings.mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
    ...
    public String getKeyBinding(Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            return settingOption == Options.MIPMAP_LEVELS && (double)f1 >= 4.0 ? s1 + Lang.get("of.general.max") : (settingOption == Options.SENSITIVITY ? (f == 0.0f ? s1 + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0f ? s1 + I18n.format("options.sensitivity.max", new Object[0]) : s1 + (int)(f * 200.0f) + "%")) : (settingOption == Options.FOV ? (f1 == 70.0f ? s1 + I18n.format("options.fov.min", new Object[0]) : (f1 == 110.0f ? s1 + I18n.format("options.fov.max", new Object[0]) : s1 + (int)f1)) : (settingOption == Options.FRAMERATE_LIMIT ? (f1 == settingOption.valueMax ? s1 + I18n.format("options.framerateLimit.max", new Object[0]) : s1 + (int)f1 + " fps") : (settingOption == Options.RENDER_CLOUDS ? (f1 == settingOption.valueMin ? s1 + I18n.format("options.cloudHeight.min", new Object[0]) : s1 + ((int)f1 + 128)) : (settingOption == Options.GAMMA ? (f == 0.0f ? s1 + I18n.format("options.gamma.min", new Object[0]) : (f == 1.0f ? s1 + I18n.format("options.gamma.max", new Object[0]) : s1 + "+" + (int)(f * 100.0f) + "%")) : (settingOption == Options.SATURATION ? s1 + (int)(f * 400.0f) + "%" : (settingOption == Options.CHAT_OPACITY ? s1 + (int)(f * 90.0f + 10.0f) + "%" : (settingOption == Options.CHAT_HEIGHT_UNFOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == Options.CHAT_HEIGHT_FOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == Options.CHAT_WIDTH ? s1 + GuiNewChat.calculateChatboxWidth(f) + "px" : (settingOption == Options.RENDER_DISTANCE ? s1 + (int)f1 + " chunks" : (settingOption == Options.MIPMAP_LEVELS ? (f1 == 0.0f ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)f1) : (settingOption == Options.STREAM_FPS ? s1 + " fps" : (settingOption == Options.STREAM_KBPS ? s1 + " Kbps" : (settingOption == Options.STREAM_BYTES_PER_PIXEL ? s1 : (f == 0.0f ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)(f * 100.0f) + "%"))))))))))))))));
        }
