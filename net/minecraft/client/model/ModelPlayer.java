...
extends ModelBiped {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (Client.instance.getModuleManager().getModuleByClass(Skeltal.class).isEnabled() && entityIn instanceof EntityPlayer) {
            Skeltal.updateModel((EntityPlayer)entityIn, this);
        }
    }
