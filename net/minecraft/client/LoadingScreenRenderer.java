    ...
    private void displayString(String message) {
        ...
        if (!this.mc.running) {
            ...
            if (OpenGlHelper.isFramebufferEnabled()) {
                ...
                LoadingScreenRenderer loadingScreenRenderer2 = this;
                GlStateManager.ortho(0.0, loadingScreenRenderer.scaledResolution.getScaledWidth() * i, loadingScreenRenderer2.scaledResolution.getScaledHeight() * i, 0.0, 100.0, 300.0);
            } else {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                if (flag) {
                    ...
                    if (customloadingscreen != null) {
                        ...
                        LoadingScreenRenderer loadingScreenRenderer = this;
                        loadingScreenRenderer.mc.getTextureManager().bindTexture(Gui.optionsBackground);
                        float f = 32.0f;
                    ...
                    Minecraft.fontRendererObj.drawStringWithShadow(this.currentlyDisplayedText, (k - Minecraft.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2, l / 2 - 4 - 16, 0xFFFFFF);
                    Minecraft.fontRendererObj.drawStringWithShadow(this.message, (k - Minecraft.fontRendererObj.getStringWidth(this.message)) / 2, l / 2 - 4 + 8, 0xFFFFFF);
                }
