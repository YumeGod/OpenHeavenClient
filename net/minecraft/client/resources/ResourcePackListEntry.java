...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        ...
        if ((this.mc.gameSettings.touchscreen || isSelected) && this.func_148310_d()) {
            ResourcePackListEntry resourcePackListEntry = this;
            resourcePackListEntry.mc.getTextureManager().bindTexture(RESOURCE_PACKS_TEXTURE);
        ...
        if ((i1 = Minecraft.fontRendererObj.getStringWidth(s)) > 157) {
            s = Minecraft.fontRendererObj.trimStringToWidth(s, 157 - Minecraft.fontRendererObj.getStringWidth("...")) + "...";
        }
        Minecraft.fontRendererObj.drawStringWithShadow(s, x + 32 + 2, y + 1, 0xFFFFFF);
        List<String> list = Minecraft.fontRendererObj.listFormattedStringToWidth(s1, 157);
        for (int l = 0; l < 2 && l < list.size(); ++l) {
            Minecraft.fontRendererObj.drawStringWithShadow(list.get(l), x + 32 + 2, y + 12 + 10 * l, 0x808080);
        }
    }
