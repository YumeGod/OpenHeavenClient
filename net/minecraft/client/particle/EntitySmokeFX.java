...
extends EntityFX {
    ...
    EntitySmokeFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i46347_8_, double p_i46347_10_, double p_i46347_12_) {
    ...
    public void onUpdate() {
        ...
        this.setParticleTextureIndex(7 - (this.particleAge << 3) / this.particleMaxAge);
        this.motionY += 0.004;
