...
import heaven.main.event.events.drakApi.RespawnEvent;
...
implements INetHandlerPlayClient {
    ...
    public void addToSendNewQueue(Packet p_addToSendQueue_1_) {
        this.netManager.sendNewPacket(p_addToSendQueue_1_);
    }
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn) {
        ...
        if (i == 1) {
            ...
            Minecraft.playerController.setGameType(WorldSettings.GameType.getByID(j));
        } else if (i == 4) {
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            ...
            Entity entity2 = this.clientWorldController.getEntityByID(packetIn.field_179774_b);
        }
    }
