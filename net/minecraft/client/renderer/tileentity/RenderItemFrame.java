...
extends Render<EntityItemFrame> {
    ...
    private void renderItem(EntityItemFrame itemFrame) {
        ...
        if (itemstack != null) {
            ...
            if (!Config.zoomMode) {
                EntityPlayerSP entity = Minecraft.thePlayer;
            ...
            if (!Reflector.postForgeBusEvent(Reflector.RenderItemInFrameEvent_Constructor, itemFrame, this)) {
                if (item instanceof ItemMap) {
                    ...
                    if (item == Items.compass) {
                        ...
                        RenderItemFrame renderItemFrame = this;
                        renderItemFrame.mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
