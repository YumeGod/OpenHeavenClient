...
public class WorldRenderer {
    ...
    private void growBuffer(int p_181670_1_) {
        if (p_181670_1_ > this.rawIntBuffer.remaining()) {
            ...
            int j = i % 0x200000;
            int k = j + (((this.rawIntBuffer.position() + p_181670_1_ << 2) - j) / 0x200000 + 1 << 21);
    ...
    public void sortVertexData(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
        ...
        if (this.quadSprites != null) {
            ...
            int i2 = this.vertexFormat.getNextOffset() / 4 << 2;
    ...
    private static float getDistanceSq(FloatBuffer p_181665_0_, float p_181665_1_, float p_181665_2_, float p_181665_3_, int p_181665_4_, int p_181665_5_) {
        ...
        float f6 = p_181665_0_.get(p_181665_5_ + (p_181665_4_ << 1));
        float f7 = p_181665_0_.get(p_181665_5_ + (p_181665_4_ << 1) + 1);
        float f8 = p_181665_0_.get(p_181665_5_ + (p_181665_4_ << 1) + 2);
    ...
    public void putBrightness4(int p_178962_1_, int p_178962_2_, int p_178962_3_, int p_178962_4_) {
        ...
        this.rawIntBuffer.put(i + (j << 1), p_178962_3_);
    ...
    public void putColorMultiplier(float red, float green, float blue, int p_178978_4_) {
        ...
        if (!this.noColor) {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                ...
                j &= Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled() ? 0x40000000 : -16777216;
                j = j | i1 << 16 | l << 8 | k;
            } else {
    ...
    public void putNormal(float x, float y, float z) {
        ...
        this.rawIntBuffer.put(j1 + (i1 << 1), l);
    ...
    public void finishDrawing() {
        ...
        this.byteBuffer.position(0);
        this.byteBuffer.limit(this.getBufferSize() << 2);
    }
    ...
    private int getBufferQuadSize() {
        return (this.rawIntBuffer.capacity() << 2) / (this.vertexFormat.getIntegerSize() << 2);
    }
    ...
    public void quadsToTriangles() {
        if (this.drawMode == 7) {
            if (this.byteBufferTriangles == null) {
                this.byteBufferTriangles = GLAllocation.createDirectByteBuffer(this.byteBuffer.capacity() << 1);
            }
            if (this.byteBufferTriangles.capacity() < this.byteBuffer.capacity() << 1) {
                this.byteBufferTriangles = GLAllocation.createDirectByteBuffer(this.byteBuffer.capacity() << 1);
            }
