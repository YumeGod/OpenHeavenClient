...
public class TextureAtlasSprite {
    ...
    public TextureAtlasSprite(String spriteName) {
        ...
        if (Config.isMultiTexture()) {
            this.spriteSingle = new TextureAtlasSprite(this.iconName + ".spriteSingle", true);
        }
    }
        ...
        if (meta == null) {
            ...
            if (meta.getFrameCount() > 0) {
                for (int i1 : meta.getFrameIndexSet()) {
                    ...
                    this.framesTextureData.set(i1, TextureAtlasSprite.getFrameTextureData(aint, i, i, i1));
                }
                this.animationMetadata = meta;
            } else {
                ArrayList list = Lists.newArrayList();
                for (int j2 = 0; j2 < j1; ++j2) {
                    this.framesTextureData.add(TextureAtlasSprite.getFrameTextureData(aint, i, i, j2));
    ...
    public List<int[][]> getFramesTextureData() {
        ArrayList<int[][]> list = new ArrayList<int[][]>(this.framesTextureData);
        return list;
    }
