...
implements IResourceManagerReloadListener {
    ...
    public void loadShader(ResourceLocation resourceLocationIn) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            try {
                ...
                this.theShaderGroup = new ShaderGroup(entityRenderer.mc.getTextureManager(), this.resourceManager, this.mc.getFramebuffer(), resourceLocationIn);
    ...
    public void updateRenderer() {
        ...
        float f2 = Minecraft.theWorld.getLightBrightness(new BlockPos(d2, d0, d1));
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null) {
            if (Minecraft.theWorld != null) {
                MovingObjectPosition vec3d1;
                this.mc.mcProfiler.startSection("pick");
                this.mc.pointedEntity = null;
                double d0 = Client.instance.getModuleManager().getModuleByClass(Reach.class).isEnabled() ? Reach.getMax() : (double)Minecraft.playerController.getBlockReachDistance();
                this.mc.objectMouseOver = entity.rayTrace(Client.instance.getModuleManager().getModuleByClass(Reach.class).isEnabled() ? Reach.getMax() : d0, partialTicks);
                double d1 = d0;
                ...
                if (Client.instance.getModuleManager().getModuleByClass(Reach.class).isEnabled() && (vec3d1 = entity.rayTrace(d1 = Reach.currentRange, partialTicks)) != null) {
                ...
                Vec3 vec33 = null;
                float f = 1.0f;
                List<Entity> list = Minecraft.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand(f, f, f), (Predicate<? super Entity>)Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::canBeCollidedWith));
                double d2 = d1;
                ...
                if (pointedEntity != null && flag) {
                    ...
                    double d3 = Client.instance.getModuleManager().getModuleByClass(Reach.class).isEnabled() ? Reach.currentRange : 3.0;
                    if (d > d3) {
                        pointedEntity = null;
    ...
    private void setupViewBobbing(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (!Client.instance.getModuleManager().getModuleByClass(Bob.class).isEnabled()) {
                GlStateManager.translate(MathHelper.sin(f1 * (float)Math.PI) * f2 * 0.5f, -Math.abs(MathHelper.cos(f1 * (float)Math.PI) * f2), 0.0f);
            } else if (!((Boolean)Bob.realBobbing.get()).booleanValue()) {
                GlStateManager.translate(MathHelper.sin(f1 * (float)Math.PI) * f2 * 0.5f, -Math.abs(MathHelper.cos(f1 * (float)Math.PI) * f2), 0.0f);
            }
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                if (Reflector.ForgeHooksClient_orientBedCamera.exists()) {
                    ...
                    objectArray[0] = Minecraft.theWorld;
                    objectArray[1] = blockpos;
                    objectArray[2] = iblockstate;
                    objectArray[3] = entity;
                    Reflector.callVoid(Reflector.ForgeHooksClient_orientBedCamera, objectArray);
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    float f4 = ((i >> 1 & 1) << 1) - 1;
                    float f5 = ((i >> 2 & 1) << 1) - 1;
                    if ((movingobjectposition = Minecraft.theWorld.rayTraceBlocks(new Vec3(d0 + (double)(f3 *= 0.1f), d1 + (double)(f4 *= 0.1f), d2 + (double)(f5 *= 0.1f)), new Vec3(d0 - d4 + (double)f3 + (double)f5, d1 - d6 + (double)f4, d2 - d5 + (double)f5))) == null || !((d7 = movingobjectposition.hitVec.distanceTo(new Vec3(d0, d1, d2))) < d3) || Client.instance.getModuleManager().getModuleByClass(ViewClip.class).isEnabled()) continue;
                    d3 = d7;
                }
                if (this.mc.gameSettings.thirdPersonView == 2) {
    ...
    public void setupCameraTransform(float partialTicks, int pass) {
        float f1;
        this.farPlaneDistance = this.mc.gameSettings.renderDistanceChunks << 4;
        ...
        if (this.mc.gameSettings.anaglyph) {
            GlStateManager.translate((float)(-((pass << 1) - 1)) * f, 0.0f, 0.0f);
        }
        this.clipDistance = this.farPlaneDistance * 2.0f;
        if (this.clipDistance < 173.0f) {
            this.clipDistance = 173.0f;
        }
        Project.gluPerspective((float)this.getFOVModifier(partialTicks, true), (float)((float)Minecraft.displayWidth / (float)Minecraft.displayHeight), (float)0.05f, (float)this.clipDistance);
        GlStateManager.matrixMode(5888);
        GlStateManager.loadIdentity();
        if (this.mc.gameSettings.anaglyph) {
            GlStateManager.translate((float)((pass << 1) - 1) * 0.1f, 0.0f, 0.0f);
        }
    ...
    public void renderHand(float p_renderHand_1_, int p_renderHand_2_, boolean p_renderHand_3_, boolean p_renderHand_4_, boolean p_renderHand_5_) {
        if (!this.debugView) {
            ...
            float f = 0.07f;
            if (this.mc.gameSettings.anaglyph) {
                GlStateManager.translate((float)(-((p_renderHand_2_ << 1) - 1)) * f, 0.0f, 0.0f);
            }
            if (Config.isShaders()) {
                Shaders.applyHandDepth();
            }
            Project.gluPerspective((float)this.getFOVModifier(p_renderHand_1_, false), (float)((float)Minecraft.displayWidth / (float)Minecraft.displayHeight), (float)0.05f, (float)(this.farPlaneDistance * 2.0f));
            GlStateManager.matrixMode(5888);
            GlStateManager.loadIdentity();
            if (this.mc.gameSettings.anaglyph) {
                GlStateManager.translate((float)((p_renderHand_2_ << 1) - 1) * 0.1f, 0.0f, 0.0f);
            }
            boolean flag = false;
            if (p_renderHand_3_) {
                boolean flag1;
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                if (Config.isCustomColors()) {
                    if (CustomColors.updateLightmap(world, this.torchFlickerX, this.lightmapColors, Minecraft.thePlayer.isPotionActive(Potion.nightVision), partialTicks)) {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            int k1 = Mouse.getX() * i1 / Minecraft.displayWidth;
            int l1 = j1 - Mouse.getY() * j1 / Minecraft.displayHeight - 1;
            ...
            if (Minecraft.theWorld != null) {
                ...
                EntityRenderer entityRenderer = this;
                TileEntityRendererDispatcher.instance.renderEngine = entityRenderer.mc.getTextureManager();
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen size", () -> {
                        ...
                        objectArray[0] = scaledresolution.getScaledWidth();
                        objectArray[1] = scaledresolution.getScaledHeight();
                        objectArray[2] = Minecraft.displayWidth;
                        objectArray[3] = Minecraft.displayHeight;
                        objectArray[4] = scaledresolution.getScaleFactor();
                        return String.format("Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %d", objectArray);
                    });
    ...
    private boolean isDrawBlockOutline() {
        ...
        if (Minecraft.playerController.getCurrentGameType() == WorldSettings.GameType.SPECTATOR) {
            if (!ReflectorForge.blockHasTileEntity(iblockstate)) return false;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        this.checkLoadVisibleChunks(entity, partialTicks, icamera, Minecraft.thePlayer.isSpectator());
        if (flag) {
            ShadersRender.setupTerrain(renderglobal, entity, partialTicks, icamera, this.frameCount++, Minecraft.thePlayer.isSpectator());
        } else {
        ...
        EntityRenderer entityRenderer2 = this;
        entityRenderer2.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).setBlurMipmap(false, this.mc.gameSettings.mipmapLevels > 0);
        renderglobal.renderBlockLayer(EnumWorldBlockLayer.CUTOUT_MIPPED, partialTicks, pass, entity);
        EntityRenderer entityRenderer3 = this;
        entityRenderer3.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
        EntityRenderer entityRenderer4 = this;
        entityRenderer4.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).setBlurMipmap(false, false);
        if (flag) {
            ShadersRender.beginTerrainCutout();
        }
        renderglobal.renderBlockLayer(EnumWorldBlockLayer.CUTOUT, partialTicks, pass, entity);
        EntityRenderer entityRenderer5 = this;
        entityRenderer5.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
        if (flag) {
        ...
        if (!renderglobal.damagedBlocks.isEmpty()) {
            ...
            EntityRenderer entityRenderer6 = this;
            entityRenderer6.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).setBlurMipmap(false, false);
            ...
            entityRenderer7.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
            GlStateManager.disableBlend();
        }
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        GlStateManager.disableBlend();
        ...
        GlStateManager.enableBlend();
        GlStateManager.depthMask(false);
        EntityRenderer entityRenderer8 = this;
        entityRenderer8.mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
        GlStateManager.shadeModel(7425);
    ...
    private void renderCloudsCheck(RenderGlobal renderGlobalIn, float partialTicks, int pass) {
        if (this.mc.gameSettings.renderDistanceChunks >= 4 && !Config.isCloudsOff() && Shaders.shouldRenderClouds(this.mc.gameSettings)) {
            ...
            GlStateManager.matrixMode(5889);
            GlStateManager.loadIdentity();
            Project.gluPerspective((float)this.getFOVModifier(partialTicks, true), (float)((float)Minecraft.displayWidth / (float)Minecraft.displayHeight), (float)0.05f, (float)(this.clipDistance * 4.0f));
            GlStateManager.matrixMode(5888);
            GlStateManager.pushMatrix();
            this.setupFog(0, partialTicks);
    ...
    private void addRainParticles() {
        if (Client.instance.getModuleManager().getModuleByClass(NoWeather.class).isEnabled()) {
            return;
        }
        ...
        if (f != 0.0f && Config.isRainSplash()) {
            if (Client.instance.getModuleManager().getModuleByClass(Atmosphere.class).isEnabled() && (Atmosphere.weather_mode.is("Snowfall") || Atmosphere.weather_mode.is("Snowstorm"))) {
                return;
            }
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        if (Reflector.ForgeWorldProvider_getWeatherRenderer.exists()) {
            WorldProvider worldprovider = Minecraft.theWorld.provider;
            Object object = Reflector.call(worldprovider, Reflector.ForgeWorldProvider_getWeatherRenderer, new Object[0]);
            if (object != null) {
                Object[] objectArray = new Object[3];
                objectArray[0] = Float.valueOf(partialTicks);
                objectArray[1] = Minecraft.theWorld;
                objectArray[2] = this.mc;
                Reflector.callVoid(object, Reflector.IRenderHandler_render, objectArray);
                return;
            }
        }
        if ((f5 = Minecraft.theWorld.getRainStrength(partialTicks)) > 0.0f) {
            if (Config.isRainOff()) {
                return;
            }
            this.enableLightmap();
            ...
            for (int k1 = k - i1; k1 <= k + i1; ++k1) {
                for (int l1 = i - i1; l1 <= i + i1; ++l1) {
                    ...
                    boolean bl = snow = Client.instance.getModuleManager().getModuleByClass(Atmosphere.class).isEnabled() && (Atmosphere.weather_mode.is("Snowstorm") || Atmosphere.weather_mode.is("Snowfall"));
                    if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15f || snow) {
                        if (j1 != 0) {
                            if (j1 >= 0) {
                                tessellator.draw();
                            }
                            j1 = 0;
                            EntityRenderer entityRenderer = this;
                            entityRenderer.mc.getTextureManager().bindTexture(locationRainPng);
                    ...
                    if (j1 != 1) {
                        ...
                        j1 = 1;
                        EntityRenderer entityRenderer = this;
                        entityRenderer.mc.getTextureManager().bindTexture(locationSnowPng);
                        worldrenderer.begin(7, DefaultVertexFormats.PARTICLE_POSITION_TEX_COLOR_LMAP);
                    }
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (this.cloudFog) {
            ...
            Vec3 vec35 = CustomColors.getUnderwaterColor(Minecraft.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0, this.mc.getRenderViewEntity().posZ);
            if (vec35 != null) {
            ...
            Vec3 vec34 = CustomColors.getUnderlavaColor(Minecraft.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0, this.mc.getRenderViewEntity().posZ);
            if (vec34 != null) {
    ...
    private void frameFinish() {
        int i;
        if (Minecraft.theWorld != null && Config.isShowGlErrors() && TimedEvent.isActive("CheckGlErrorFrameFinish", 10000L) && (i = GlStateManager.glGetError()) != 0 && GlErrors.isEnabled(i)) {
