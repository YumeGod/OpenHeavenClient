...
import heaven.main.event.events.rendering.EventPostRenderPlayer;
import heaven.main.event.events.rendering.EventPreRenderPlayer;
...
extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        EventManager.call(new EventPreRenderPlayer());
        ...
        EventManager.call(new EventPostRenderPlayer());
    }
    ...
    protected void renderLivingAt(AbstractClientPlayer entityLivingBaseIn, double x, double y, double z) {
        if (entityLivingBaseIn.isEntityAlive() && entityLivingBaseIn.isPlayerSleeping()) {
            ...
            PlayerSize.setSize(entityLivingBaseIn);
