            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1) {
                        ...
                        worldrenderer.pos(d10 + d2, y + (double)(i1 << 4), d11 + d3).color(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                        worldrenderer.pos(d8 + d4, y + (double)(i1 + 1 << 4), d9 + d5).color(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                    }
                    tessellator.draw();
                }
            }
