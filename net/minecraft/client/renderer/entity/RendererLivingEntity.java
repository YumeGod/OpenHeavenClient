...
import heaven.main.utils.render.OutlineUtils;
...
extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        EventRenderEntity eventPre = new EventRenderEntity((Entity)entity, Event.State.PRE);
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z)) {
            ...
            try {
                ...
                float f7 = entity == Minecraft.thePlayer ? ((EntityLivingBase)entity).prevRotationPitchHead + (((EntityLivingBase)entity).rotationPitchHead - ((EntityLivingBase)entity).prevRotationPitchHead) * partialTicks : ((EntityLivingBase)entity).prevRotationPitch + (((EntityLivingBase)entity).rotationPitch - ((EntityLivingBase)entity).prevRotationPitch) * partialTicks;
                this.renderLivingAt(entity, x, y, z);
                float f8 = !Client.instance.getModuleManager().getModuleByClass(Chams.class).isEnabled() ? this.handleRotationFloat(entity, partialTicks) : ((EntityLivingBase)entity).prevRotationPitch + (((EntityLivingBase)entity).rotationPitch - ((EntityLivingBase)entity).prevRotationPitch) * partialTicks;
                ...
                if (entity instanceof EntityPlayer) {
                    RLEEvent rleEvent = new RLEEvent((EntityLivingBase)entity, f6, f5, f7, f2, f8, f, 0.0625f, partialTicks);
                ...
                if (this.renderOutlines) {
                    ...
                    if (ESP.mode.is("Outline") && esp.isEnabled()) {
            ...
            if (entity instanceof EntityPlayer) {
                RLEEvent rleEvent = new RLEEvent((EntityLivingBase)entity);
                EventManager.call(rleEvent);
            }
        ...
        EventRenderEntity eventPost = new EventRenderEntity((Entity)entity, Event.State.POST);
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (flag1) {
            if (Client.instance.getModuleManager().getModuleByClass(EntityHurtColor.class).isEnabled()) {
                this.brightnessBuffer.put(((Double)EntityHurtColor.r.get()).floatValue() / 255.0f);
                this.brightnessBuffer.put(((Double)EntityHurtColor.g.get()).floatValue() / 255.0f);
                this.brightnessBuffer.put(((Double)EntityHurtColor.b.get()).floatValue() / 255.0f);
                this.brightnessBuffer.put(((Double)EntityHurtColor.alpha.get()).floatValue() / 255.0f);
            } else {
