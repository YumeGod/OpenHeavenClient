    ...
    private void renderPainting(EntityPainting painting, int width, int height, int textureU, int textureV) {
        ...
        for (int i = 0; i < width / 16; ++i) {
            for (int j = 0; j < height / 16; ++j) {
                float f15 = f + (float)(i + 1 << 4);
                float f16 = f + (float)(i << 4);
                float f17 = f1 + (float)(j + 1 << 4);
                float f18 = f1 + (float)(j << 4);
                this.setLightmap(painting, (f15 + f16) / 2.0f, (f17 + f18) / 2.0f);
                float f19 = (float)(textureU + width - (i << 4)) / 256.0f;
                float f20 = (float)(textureU + width - (i + 1 << 4)) / 256.0f;
                float f21 = (float)(textureV + height - (j << 4)) / 256.0f;
                float f22 = (float)(textureV + height - (j + 1 << 4)) / 256.0f;
