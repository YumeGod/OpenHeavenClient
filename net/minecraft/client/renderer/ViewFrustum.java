...
public class ViewFrustum {
    ...
    private final Map<ChunkCoordIntPair, VboRegion[]> mapVboRegions = new HashMap<ChunkCoordIntPair, VboRegion[]>();
        ...
        for (int k = 0; k < this.countChunksX; ++k) {
            for (int l = 0; l < this.countChunksY; ++l) {
                for (int i1 = 0; i1 < this.countChunksZ; ++i1) {
                    ...
                    BlockPos blockpos = new BlockPos(k << 4, l << 4, i1 << 4);
    ...
    protected void setCountChunksXYZ(int renderDistanceChunks) {
        int i;
        this.countChunksX = i = (renderDistanceChunks << 1) + 1;
    ...
    public void deleteVboRegions() {
        for (VboRegion[] avboregion : this.mapVboRegions.values()) {
