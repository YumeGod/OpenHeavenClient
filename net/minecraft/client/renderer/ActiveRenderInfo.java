...
public class ActiveRenderInfo {
    ...
    public static void updateRenderInfo(EntityPlayer entityplayerIn, boolean p_74583_1_) {
        ...
        rotationX = MathHelper.cos(f3 * (float)Math.PI / 180.0f) * (float)(1 - (i << 1));
        rotationZ = MathHelper.sin(f3 * (float)Math.PI / 180.0f) * (float)(1 - (i << 1));
        rotationYZ = -rotationZ * MathHelper.sin(f2 * (float)Math.PI / 180.0f) * (float)(1 - (i << 1));
        rotationXY = rotationX * MathHelper.sin(f2 * (float)Math.PI / 180.0f) * (float)(1 - (i << 1));
