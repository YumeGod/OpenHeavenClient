...
public class RenderChunk {
    ...
    public RenderChunk(World worldIn, RenderGlobal renderGlobalIn, BlockPos blockPosIn, int indexIn) {
        ...
        this.index = indexIn;
        if (!blockPosIn.equals(this.position)) {
    ...
    public void setPosition(BlockPos pos) {
        ChunkAnimator m = (ChunkAnimator)Client.instance.getModuleManager().getModuleByClass(ChunkAnimator.class);
        if (m.isEnabled()) {
    ...
    public BlockPos getPositionOffset16(EnumFacing p_getPositionOffset16_1_) {
        ...
        if (blockpos == null) {
            this.positionOffsets16[i] = blockpos = this.position.offset(p_getPositionOffset16_1_, 16);
        }
        return blockpos;
    }
    ...
    private void updateRenderChunkNeighboursValid() {
        ...
        this.renderChunkNeighboursValid[k] = this.renderChunkNeighbours[k].position.getZ() == j - 16 ? this.renderChunkNeighbours[k] : null;
        this.renderChunkNeighboursValid[l] = this.renderChunkNeighbours[l].position.getZ() == j + 16 ? this.renderChunkNeighbours[l] : null;
        this.renderChunkNeighboursValid[i1] = this.renderChunkNeighbours[i1].position.getX() == i - 16 ? this.renderChunkNeighbours[i1] : null;
        this.renderChunkNeighboursValid[j1] = this.renderChunkNeighbours[j1].position.getX() == i + 16 ? this.renderChunkNeighbours[j1] : null;
    ...
    public String toString() {
        return "pos: " + this.position + ", frameIndex: " + this.frameIndex;
    }
