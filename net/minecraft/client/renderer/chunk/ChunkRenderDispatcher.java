...
public class ChunkRenderDispatcher {
    ...
    final BlockingQueue<ChunkCompileTaskGenerator> queueChunkUpdates = Queues.newArrayBlockingQueue((int)100);
    ...
    private final List<RegionRenderCacheBuilder> listPausedBuilders = new ArrayList<RegionRenderCacheBuilder>();
    ...
    public ChunkRenderDispatcher(int p_i4_1_) {
        ...
        this.countRenderBuilders = p_i4_1_ < 0 ? MathHelper.clamp_int(j << 3, 1, i) : p_i4_1_;
        for (int k = 0; k < j; ++k) {
