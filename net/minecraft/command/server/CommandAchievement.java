        ...
        if (flag || flag1) {
            if (statbase == null) {
                ...
                if (flag) {
                    ...
                    CommandAchievement.notifyOperators(sender, (ICommand)this, "commands.achievement.give.success.one", entityplayermp.getName(), statbase.createChatComponent());
                } else if (flag1) {
                    entityplayermp.func_175145_a(statbase);
                    CommandAchievement.notifyOperators(sender, (ICommand)this, "commands.achievement.take.success.one", statbase.createChatComponent(), entityplayermp.getName());
                }
            }
        }
    }
