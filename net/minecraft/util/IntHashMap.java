...
public class IntHashMap<V> {
    ...
    static int computeHash(int integer) {
    ...
    static class Entry<V> {
        ...
        public final boolean equals(Object p_equals_1_) {
            ...
            Integer object = this.hashEntry;
            return (object == (object1 = Integer.valueOf(entry.hashEntry)) || ((Object)object1).equals(object)) && ((object2 = this.valueEntry) == (object3 = entry.valueEntry) || object2 != null && object2.equals(object3));
        }
        ...
        public final String toString() {
            return this.hashEntry + "=" + this.valueEntry;
        }
    }
}
