...
public class MathHelper {
    ...
    public static double sin(double p_76126_0_) {
        return fastMath ? (double)SIN_TABLE_FAST[(int)(p_76126_0_ * (double)radToIndex) & 0xFFF] : (double)SIN_TABLE[(int)(p_76126_0_ * 10430.3779296875) & 0xFFFF];
    }
    ...
    public static double cos(double value) {
        return fastMath ? (double)SIN_TABLE_FAST[(int)(value * (double)radToIndex + 1024.0) & 0xFFF] : (double)SIN_TABLE[(int)(value * 10430.3779296875 + 16384.0) & 0xFFFF];
    }
