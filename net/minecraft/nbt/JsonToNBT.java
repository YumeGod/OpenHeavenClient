...
public class JsonToNBT {
    ...
    public static NBTTagCompound getTagFromJson(String jsonString) throws NBTException {
        if ((jsonString = jsonString.trim()).isEmpty() || jsonString.charAt(0) != '{') {
    ...
    static Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
        ...
        if (!p_150316_1_.isEmpty() && p_150316_1_.charAt(0) == '[' && !field_179273_b.matcher(p_150316_1_).matches()) {
            p_150316_1_ = p_150316_1_.substring(1, p_150316_1_.length() - 1);
    ...
    private static String func_150313_b(String p_150313_0_, boolean p_150313_1_) throws NBTException {
        if (p_150313_1_ && (!(p_150313_0_ = p_150313_0_.trim()).isEmpty() && p_150313_0_.charAt(0) == '{' || !p_150313_0_.isEmpty() && p_150313_0_.charAt(0) == '[')) {
            return "";
        }
    ...
    private static String func_150311_c(String p_150311_0_, boolean p_150311_1_) throws NBTException {
        if (p_150311_1_ && (!(p_150311_0_ = p_150311_0_.trim()).isEmpty() && p_150311_0_.charAt(0) == '{' || !p_150311_0_.isEmpty() && p_150311_0_.charAt(0) == '[')) {
            return p_150311_0_;
        }
    ...
    extends Any {
        ...
        public NBTBase parse() {
            ...
            if (!this.jsonValue.isEmpty() && this.jsonValue.charAt(0) == '[' && !this.jsonValue.isEmpty() && this.jsonValue.charAt(this.jsonValue.length() - 1) == ']') {
