...
implements IChunkProvider {
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        BiomeGenBase[] biomeGenBaseArray = this.worldObj.getWorldChunkManager().loadBlockGeneratorData(null, x << 4, z << 4, 16, 16);
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z) {
        ...
        long k = (this.random.nextLong() / 2L << 1) + 1L;
        long l = (this.random.nextLong() / 2L << 1) + 1L;
