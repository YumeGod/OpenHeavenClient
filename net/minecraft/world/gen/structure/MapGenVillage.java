...
extends MapGenStructure {
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
        ...
        return i == (k += random.nextInt(this.field_82665_g - this.field_82666_h)) && j == (l += random.nextInt(this.field_82665_g - this.field_82666_h)) && (flag = this.worldObj.getWorldChunkManager().areBiomesViable((i << 4) + 8, (j << 4) + 8, 0, villageSpawnBiomes));
    }
