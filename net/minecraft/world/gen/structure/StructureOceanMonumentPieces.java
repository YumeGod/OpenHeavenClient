...
public class StructureOceanMonumentPieces {
    ...
    extends StructureComponent {
        ...
        protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_, RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_) {
            ...
            int k = i / 5 % 5;
            int l = i / 25;
            this.boundingBox = p_i45590_2_ != EnumFacing.NORTH && p_i45590_2_ != EnumFacing.SOUTH ? new StructureBoundingBox(0, 0, 0, (p_i45590_6_ << 3) - 1, (p_i45590_5_ << 2) - 1, (p_i45590_4_ << 3) - 1) : new StructureBoundingBox(0, 0, 0, (p_i45590_4_ << 3) - 1, (p_i45590_5_ << 2) - 1, (p_i45590_6_ << 3) - 1);
            switch (p_i45590_2_) {
                case NORTH: {
                    this.boundingBox.offset(j << 3, l << 2, (-(k + p_i45590_6_) << 3) + 1);
                    break;
                }
                case SOUTH: {
                    this.boundingBox.offset(j << 3, l << 2, k << 3);
                    break;
                }
                case WEST: {
                    this.boundingBox.offset((-(k + p_i45590_6_) << 3) + 1, l << 2, j << 3);
                    break;
                }
                default: {
                    this.boundingBox.offset(k << 3, l << 2, j << 3);
                }
            }
        }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int l1 = 0; l1 < 5; ++l1) {
                this.func_181655_a(worldIn, structureBoundingBoxIn, -1 - l1, l1 << 1, -1 - l1, -1 - l1, 23, 58 + l1, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, 58 + l1, l1 << 1, -1 - l1, 58 + l1, 23, 58 + l1, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, -l1, l1 << 1, -1 - l1, 57 + l1, 23, -1 - l1, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, -l1, l1 << 1, 58 + l1, 57 + l1, 23, 58 + l1, false);
            }
            for (Piece structureoceanmonumentpieces$piece : this.field_175843_q) {
        ...
        private void func_175839_b(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_) {
            if (this.func_175818_a(p_175839_3_, 22, 5, 35, 17)) {
                ...
                for (int i = 0; i < 4; ++i) {
                    this.fillWithBlocks(worldIn, p_175839_3_, 24, 2, 5 + (i << 2), 24, 4, 5 + (i << 2), field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 22, 4, 5 + (i << 2), 23, 4, 5 + (i << 2), field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 25, 5, 5 + (i << 2), p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 26, 6, 5 + (i << 2), p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 26, 5, 5 + (i << 2), p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 33, 2, 5 + (i << 2), 33, 4, 5 + (i << 2), field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 34, 4, 5 + (i << 2), 35, 4, 5 + (i << 2), field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 32, 5, 5 + (i << 2), p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 31, 6, 5 + (i << 2), p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 31, 5, 5 + (i << 2), p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 27, 6, 5 + (i << 2), 30, 6, 5 + (i << 2), field_175828_a, field_175828_a, false);
                }
            }
        }
        ...
        private void func_175837_c(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_) {
            if (this.func_175818_a(p_175837_3_, 15, 20, 42, 21)) {
                ...
                for (int k = 0; k < 3; ++k) {
                    this.setBlockState(worldIn, field_175827_c, 22 - (k << 1), 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 22 - (k << 1), 9, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + (k << 1), 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + (k << 1), 9, 21, p_175837_3_);
                }
