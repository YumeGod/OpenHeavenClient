    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        for (int k1 = 0; k1 < 16; ++k1) {
            for (int l2 = 0; l2 < 16; ++l2) {
                for (int k = 0; k < 8; ++k) {
                    boolean flag;
                    boolean bl = flag = !aboolean[((k1 << 4) + l2 << 3) + k] && (k1 < 15 && aboolean[((k1 + 1 << 4) + l2 << 3) + k] || k1 > 0 && aboolean[((k1 - 1 << 4) + l2 << 3) + k] || l2 < 15 && aboolean[((k1 << 4) + l2 + 1 << 3) + k] || l2 > 0 && aboolean[((k1 << 4) + (l2 - 1) << 3) + k] || k < 7 && aboolean[((k1 << 4) + l2 << 3) + k + 1] || k > 0 && aboolean[((k1 << 4) + l2 << 3) + (k - 1)]);
                    if (!flag) continue;
        ...
        for (int l1 = 0; l1 < 16; ++l1) {
            for (int i3 = 0; i3 < 16; ++i3) {
                for (int i4 = 0; i4 < 8; ++i4) {
                    if (!aboolean[((l1 << 4) + i3 << 3) + i4]) continue;
        ...
        for (int i2 = 0; i2 < 16; ++i2) {
            for (int j3 = 0; j3 < 16; ++j3) {
                for (int j4 = 4; j4 < 8; ++j4) {
                    BlockPos blockpos;
                    if (!aboolean[((i2 << 4) + j3 << 3) + j4] || worldIn.getBlockState(blockpos = position.add(i2, j4 - 1, j3)).getBlock() != Blocks.dirt || worldIn.getLightFor(EnumSkyBlock.SKY, position.add(i2, j4, j3)) <= 0) continue;
            ...
            for (int j2 = 0; j2 < 16; ++j2) {
                for (int k3 = 0; k3 < 16; ++k3) {
                    for (int k4 = 0; k4 < 8; ++k4) {
                        boolean flag1;
                        boolean bl = flag1 = !aboolean[((j2 << 4) + k3 << 3) + k4] && (j2 < 15 && aboolean[((j2 + 1 << 4) + k3 << 3) + k4] || j2 > 0 && aboolean[((j2 - 1 << 4) + k3 << 3) + k4] || k3 < 15 && aboolean[((j2 << 4) + k3 + 1 << 3) + k4] || k3 > 0 && aboolean[((j2 << 4) + (k3 - 1) << 3) + k4] || k4 < 7 && aboolean[((j2 << 4) + k3 << 3) + k4 + 1] || k4 > 0 && aboolean[((j2 << 4) + k3 << 3) + (k4 - 1)]);
