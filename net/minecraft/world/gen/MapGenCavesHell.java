...
extends MapGenBase {
    ...
    protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_) {
        boolean flag;
        double d0 = (p_180704_3_ << 4) + 8;
        double d1 = (p_180704_4_ << 4) + 8;
        float f = 0.0f;
        float f1 = 0.0f;
        ...
        while (p_180704_15_ < p_180704_16_) {
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_180704_6_ >= d0 - 16.0 - d2 * 2.0 && p_180704_10_ >= d1 - 16.0 - d2 * 2.0 && p_180704_6_ <= d0 + 16.0 + d2 * 2.0 && p_180704_10_ <= d1 + 16.0 + d2 * 2.0) {
                    int j2 = MathHelper.floor_double(p_180704_6_ - d2) - (p_180704_3_ << 4) - 1;
                    int k = MathHelper.floor_double(p_180704_6_ + d2) - (p_180704_3_ << 4) + 1;
                    int k2 = MathHelper.floor_double(p_180704_8_ - d3) - 1;
                    int l = MathHelper.floor_double(p_180704_8_ + d3) + 1;
                    int l2 = MathHelper.floor_double(p_180704_10_ - d2) - (p_180704_4_ << 4) - 1;
                    int i1 = MathHelper.floor_double(p_180704_10_ + d2) - (p_180704_4_ << 4) + 1;
                    if (j2 < 0) {
                        j2 = 0;
                    }
                    if (k > 16) {
                    ...
                    if (!flag2) {
                        for (int i3 = j2; i3 < k; ++i3) {
                            double d10 = ((double)(i3 + (p_180704_3_ << 4)) + 0.5 - p_180704_6_) / d2;
                            for (int j3 = l2; j3 < i1; ++j3) {
                                double d8 = ((double)(j3 + (p_180704_4_ << 4)) + 0.5 - p_180704_10_) / d2;
