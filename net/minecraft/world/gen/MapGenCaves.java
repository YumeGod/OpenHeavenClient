...
extends MapGenBase {
    ...
    protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
        boolean flag;
        double d0 = (p_180702_3_ << 4) + 8;
        double d1 = (p_180702_4_ << 4) + 8;
        float f = 0.0f;
        float f1 = 0.0f;
        ...
        while (p_180702_15_ < p_180702_16_) {
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_180702_6_ >= d0 - 16.0 - d2 * 2.0 && p_180702_10_ >= d1 - 16.0 - d2 * 2.0 && p_180702_6_ <= d0 + 16.0 + d2 * 2.0 && p_180702_10_ <= d1 + 16.0 + d2 * 2.0) {
                    int k2 = MathHelper.floor_double(p_180702_6_ - d2) - (p_180702_3_ << 4) - 1;
                    int k = MathHelper.floor_double(p_180702_6_ + d2) - (p_180702_3_ << 4) + 1;
                    int l2 = MathHelper.floor_double(p_180702_8_ - d3) - 1;
                    int l = MathHelper.floor_double(p_180702_8_ + d3) + 1;
                    int i3 = MathHelper.floor_double(p_180702_10_ - d2) - (p_180702_4_ << 4) - 1;
                    int i1 = MathHelper.floor_double(p_180702_10_ + d2) - (p_180702_4_ << 4) + 1;
                    if (k2 < 0) {
                        k2 = 0;
                    }
                    if (k > 16) {
                    ...
                    if (!flag3) {
                        ...
                        for (int j3 = k2; j3 < k; ++j3) {
                            double d10 = ((double)(j3 + (p_180702_3_ << 4)) + 0.5 - p_180702_6_) / d2;
                            for (int i2 = i3; i2 < i1; ++i2) {
                                double d8 = ((double)(i2 + (p_180702_4_ << 4)) + 0.5 - p_180702_10_) / d2;
                                boolean flag1 = false;
                                ...
                                for (int j2 = l; j2 > l2; --j2) {
                                    ...
                                    blockpos$mutableblockpos.set(j3 + (p_180702_3_ << 4), 0, i2 + (p_180702_4_ << 4));
