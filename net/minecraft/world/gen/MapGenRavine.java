...
extends MapGenBase {
    ...
    protected void func_180707_a(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, double p_180707_17_) {
        ...
        double d0 = (p_180707_3_ << 4) + 8;
        double d1 = (p_180707_4_ << 4) + 8;
        float f = 0.0f;
        float f1 = 0.0f;
        if (p_180707_16_ <= 0) {
            int i = (this.range << 4) - 16;
        ...
        while (p_180707_15_ < p_180707_16_) {
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_180707_6_ >= d0 - 16.0 - d9 * 2.0 && p_180707_10_ >= d1 - 16.0 - d9 * 2.0 && p_180707_6_ <= d0 + 16.0 + d9 * 2.0 && p_180707_10_ <= d1 + 16.0 + d9 * 2.0) {
                    int k2 = MathHelper.floor_double(p_180707_6_ - d9) - (p_180707_3_ << 4) - 1;
                    int k = MathHelper.floor_double(p_180707_6_ + d9) - (p_180707_3_ << 4) + 1;
                    int l2 = MathHelper.floor_double(p_180707_8_ - d2) - 1;
                    int l = MathHelper.floor_double(p_180707_8_ + d2) + 1;
                    int i3 = MathHelper.floor_double(p_180707_10_ - d9) - (p_180707_4_ << 4) - 1;
                    int i1 = MathHelper.floor_double(p_180707_10_ + d9) - (p_180707_4_ << 4) + 1;
                    if (k2 < 0) {
                        k2 = 0;
                    }
                    if (k > 16) {
                    ...
                    if (!flag2) {
                        ...
                        for (int j3 = k2; j3 < k; ++j3) {
                            double d10 = ((double)(j3 + (p_180707_3_ << 4)) + 0.5 - p_180707_6_) / d9;
                            for (int i2 = i3; i2 < i1; ++i2) {
                                double d7 = ((double)(i2 + (p_180707_4_ << 4)) + 0.5 - p_180707_10_) / d9;
                                boolean flag = false;
                                ...
                                for (int j2 = l; j2 > l2; --j2) {
                                    ...
                                    blockpos$mutableblockpos.set(j3 + (p_180707_3_ << 4), 0, i2 + (p_180707_4_ << 4));
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        if (this.rand.nextInt(50) == 0) {
            double d0 = (chunkX << 4) + this.rand.nextInt(16);
            double d1 = this.rand.nextInt(this.rand.nextInt(40) + 8) + 20;
            double d2 = (chunkZ << 4) + this.rand.nextInt(16);
            int i = 1;
            for (int j = 0; j < i; ++j) {
