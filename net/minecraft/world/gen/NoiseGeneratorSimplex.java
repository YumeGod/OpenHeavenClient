...
public class NoiseGeneratorSimplex {
    ...
    public static final double field_151614_a = 1.7320508075688772;
    ...
    private static final double field_151609_g = 0.3660254037844386;
    private static final double field_151615_h = 0.21132486540518713;
    ...
    public double func_151605_a(double p_151605_1_, double p_151605_3_) {
        ...
        int j;
        double d6;
        double d3 = 0.3660254037844386;
        double d4 = (p_151605_1_ + p_151605_3_) * d3;
        int i = NoiseGeneratorSimplex.func_151607_a(p_151605_1_ + d4);
        double d7 = (double)i - (d6 = (double)(i + (j = NoiseGeneratorSimplex.func_151607_a(p_151605_3_ + d4))) * (d5 = 0.21132486540518713));
    ...
    public void func_151606_a(double[] p_151606_1_, double p_151606_2_, double p_151606_4_, int p_151606_6_, int p_151606_7_, double p_151606_8_, double p_151606_10_, double p_151606_12_) {
        ...
        for (int j = 0; j < p_151606_7_; ++j) {
            ...
            for (int k = 0; k < p_151606_6_; ++k) {
                ...
                double d5 = (d1 + d0) * 0.3660254037844386;
                int l = NoiseGeneratorSimplex.func_151607_a(d1 + d5);
                double d7 = (double)l - (d6 = (double)(l + (i1 = NoiseGeneratorSimplex.func_151607_a(d0 + d5))) * 0.21132486540518713);
                double d9 = d1 - d7;
                ...
                double d11 = d9 - (double)j1 + 0.21132486540518713;
                double d12 = d10 - (double)k1 + 0.21132486540518713;
                double d13 = d9 - 1.0 + 0.42264973081037427;
                double d14 = d10 - 1.0 + 0.42264973081037427;
                int l1 = l & 0xFF;
                int i2 = i1 & 0xFF;
