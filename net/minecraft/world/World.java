...
implements IBlockAccess {
    ...
    public Block getGroundAboveSeaLevel(BlockPos pos) {
        BlockPos blockpos = new BlockPos(pos.getX(), this.seaLevel, pos.getZ());
    ...
    public BlockPos getHeight(BlockPos pos) {
        int i = pos.getX() >= -30000000 && pos.getZ() >= -30000000 && pos.getX() < 30000000 && pos.getZ() < 30000000 ? (this.isChunkLoaded(pos.getX() >> 4, pos.getZ() >> 4, true) ? this.getChunkFromChunkCoords(pos.getX() >> 4, pos.getZ() >> 4).getHeightValue(pos.getX() & 0xF, pos.getZ() & 0xF) : 0) : this.seaLevel + 1;
    ...
    protected void onEntityAdded(Entity entityIn) {
        EntityAddedEvent EntityAddedEvent2 = new EntityAddedEvent(entityIn);
        EventManager.call(EntityAddedEvent2);
        for (int i = 0; i < this.worldAccesses.size(); ++i) {
    ...
    public BlockPos getSpawnPoint() {
        ...
        if (!this.worldBorder.contains(blockpos)) {
            blockpos = this.getHeight(new BlockPos(this.worldBorder.getCenterX(), 0.0, this.worldBorder.getCenterZ()));
        }
        return blockpos;
    }
    ...
    public Random setRandomSeed(int p_72843_1_, int p_72843_2_, int p_72843_3_) {
        long i = (long)p_72843_1_ * 341873128712L + (long)p_72843_2_ * 132897987541L + this.worldInfo.getSeed() + (long)p_72843_3_;
        this.rand.setSeed(i);
        return this.rand;
    }

    public BlockPos getStrongholdPos(String name, BlockPos pos) {
        return this.chunkProvider.getStrongholdGen(this, name, pos);
    }
    ...
    public double getHorizon() {
        if (Client.instance.getModuleManager().getModuleByClass(VoidFlickFix.class).isEnabled()) {
            return 0.0;
        }
    ...
    public boolean isSpawnChunk(int x, int z) {
        ...
        int i = (x << 4) + 8 - blockpos.getX();
        int j = (z << 4) + 8 - blockpos.getZ();
        int k = 128;
    ...
    public Block getBlock(double x, double y, double z) {
        return this.getBlockState(new BlockPos((int)x, (int)y, (int)z)).getBlock();
    }
}
