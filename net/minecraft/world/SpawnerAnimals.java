...
public final class SpawnerAnimals {
    ...
    protected static BlockPos getRandomChunkPosition(World worldIn, int x, int z) {
        ...
        int i = (x << 4) + worldIn.rand.nextInt(16);
        int j = (z << 4) + worldIn.rand.nextInt(16);
    ...
    private static BlockPosM getRandomChunkPosition(World p_getRandomChunkPosition_0_, int p_getRandomChunkPosition_1_, int p_getRandomChunkPosition_2_, BlockPosM p_getRandomChunkPosition_3_) {
        ...
        int i = (p_getRandomChunkPosition_1_ << 4) + p_getRandomChunkPosition_0_.rand.nextInt(16);
        int j = (p_getRandomChunkPosition_2_ << 4) + p_getRandomChunkPosition_0_.rand.nextInt(16);
        int k = MathHelper.roundUp(chunk.getHeightValue(i & 0xF, j & 0xF) + 1, 16);
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType spawnPlacementTypeIn, World worldIn, BlockPos pos) {
        ...
        boolean bl = flag = Reflector.ForgeBlock_canCreatureSpawn.exists() ? Reflector.callBoolean(iblockstate.getBlock(), Reflector.ForgeBlock_canCreatureSpawn, new Object[]{worldIn, blockpos, spawnPlacementTypeIn}) : World.doesBlockHaveSolidTopSurface(worldIn, blockpos);
        if (!flag) {
            return false;
        }
