...
public class BiomeDecorator {
    ...
    protected void genDecorations(BiomeGenBase biomeGenBaseIn) {
        ...
        for (int i3 = 0; i3 < this.grassPerChunk; ++i3) {
            ...
            int k14 = this.currentWorld.getHeight(this.field_180294_c.add(j7, 0, i11 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (k14 <= 0) continue;
        ...
        for (int j3 = 0; j3 < this.deadBushPerChunk; ++j3) {
            ...
            int l14 = this.currentWorld.getHeight(this.field_180294_c.add(k7, 0, j11 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (l14 <= 0) continue;
        ...
        for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
            ...
            int i15 = this.currentWorld.getHeight(this.field_180294_c.add(l7, 0, k11 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (i15 <= 0) continue;
        ...
        for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
            ...
            if (this.randomGenerator.nextInt(8) != 0 || (j15 = this.currentWorld.getHeight(this.field_180294_c.add(j8 = this.randomGenerator.nextInt(16) + 8, 0, i12 = this.randomGenerator.nextInt(16) + 8)).getY() << 1) <= 0) continue;
        ...
        if (this.randomGenerator.nextInt(4) == 0 && (j12 = this.currentWorld.getHeight(this.field_180294_c.add(i4 = this.randomGenerator.nextInt(16) + 8, 0, k8 = this.randomGenerator.nextInt(16) + 8)).getY() << 1) > 0) {
        ...
        if (this.randomGenerator.nextInt(8) == 0 && (k12 = this.currentWorld.getHeight(this.field_180294_c.add(j4 = this.randomGenerator.nextInt(16) + 8, 0, l8 = this.randomGenerator.nextInt(16) + 8)).getY() << 1) > 0) {
        ...
        for (int k4 = 0; k4 < this.reedsPerChunk; ++k4) {
            ...
            int i16 = this.currentWorld.getHeight(this.field_180294_c.add(i9, 0, l12 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (i16 <= 0) continue;
        ...
        for (int l4 = 0; l4 < 10; ++l4) {
            ...
            int j16 = this.currentWorld.getHeight(this.field_180294_c.add(j9, 0, i13 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (j16 <= 0) continue;
        ...
        if (this.randomGenerator.nextInt(32) == 0 && (j13 = this.currentWorld.getHeight(this.field_180294_c.add(i5 = this.randomGenerator.nextInt(16) + 8, 0, k9 = this.randomGenerator.nextInt(16) + 8)).getY() << 1) > 0) {
        ...
        for (int j5 = 0; j5 < this.cactiPerChunk; ++j5) {
            ...
            int l16 = this.currentWorld.getHeight(this.field_180294_c.add(l9, 0, k13 = this.randomGenerator.nextInt(16) + 8)).getY() << 1;
            if (l16 <= 0) continue;
