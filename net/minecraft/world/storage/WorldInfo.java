...
public class WorldInfo {
    ...
    WorldType terrainType = WorldType.DEFAULT;
    ...
    public void setWorldTime(long time) {
        this.worldTime = Client.instance.getModuleManager().getModuleByClass(Atmosphere.class).isEnabled() ? Atmosphere.getTime() : time;
    }
