                ...
                if (!this.worldPointer.isRemote) {
                    ...
                    for (int j = -1; j <= 1; ++j) {
                        for (int k = -1; k <= 1; ++k) {
                            ...
                            if (this.worldPointer.getBlockState(this.position.add(k << 1, 0, j << 1)).getBlock() == Blocks.bookshelf) {
                                ++l;
                            }
                            if (this.worldPointer.getBlockState(this.position.add(k << 1, 1, j << 1)).getBlock() == Blocks.bookshelf) {
                                ++l;
                            }
                            if (k == 0 || j == 0) continue;
                            if (this.worldPointer.getBlockState(this.position.add(k << 1, 0, j)).getBlock() == Blocks.bookshelf) {
                                ++l;
                            }
                            if (this.worldPointer.getBlockState(this.position.add(k << 1, 1, j)).getBlock() == Blocks.bookshelf) {
                                ++l;
                            }
                            if (this.worldPointer.getBlockState(this.position.add(k, 0, j << 1)).getBlock() == Blocks.bookshelf) {
                                ++l;
                            }
                            if (this.worldPointer.getBlockState(this.position.add(k, 1, j << 1)).getBlock() != Blocks.bookshelf) continue;
                            ++l;
                        }
                    }
