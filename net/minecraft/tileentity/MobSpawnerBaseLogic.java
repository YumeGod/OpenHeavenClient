...
public abstract class MobSpawnerBaseLogic {
    ...
    private String getEntityNameToSpawn() {
        ...
        return this.randomEntity.entityType;
    }
    ...
    private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
        if (this.randomEntity != null) {
            ...
            for (String s : this.randomEntity.nbtData.getKeySet()) {
                NBTBase nbtbase = this.randomEntity.nbtData.getTag(s);
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        if (!StringUtils.isNullOrEmpty(s)) {
            ...
            if (this.randomEntity != null) {
                nbt.setTag("SpawnData", this.randomEntity.nbtData.copy());
            }
            if (this.randomEntity != null || !this.minecartToSpawn.isEmpty()) {
                ...
                if (!this.minecartToSpawn.isEmpty()) {
                    ...
                    nbttaglist.appendTag(this.randomEntity.toNBT());
                }
