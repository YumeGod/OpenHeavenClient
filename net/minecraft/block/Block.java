...
public class Block {
    ...
    public static EnumFacing getFacingDirection(BlockPos pos) {
        ...
        return (rayResult = Minecraft.theWorld.rayTraceBlocks(new Vec3(Minecraft.thePlayer.posX, Minecraft.thePlayer.posY + (double)Minecraft.thePlayer.getEyeHeight(), Minecraft.thePlayer.posZ), new Vec3((double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5))) != null ? rayResult.sideHit : direction;
    }
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
        ...
        int i = worldIn.getCombinedLight(pos, Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled() ? 1000000 : block.lightValue);
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        EventManager.call(new EventBlockRenderSide(worldIn, pos, side, this.maxX, this.minX, this.maxY, this.minY, this.maxZ, this.minZ));
        if (((Boolean)((Xray)Client.instance.getModuleManager().getModuleByClass(Xray.class)).hypixelUhc.getValue()).booleanValue()) {
            for (Block block : Lists.newArrayList((Object[])new Block[]{Blocks.diamond_ore, Blocks.coal_ore, Blocks.emerald_ore, Blocks.gold_ore, Blocks.iron_ore, Blocks.lapis_ore, Blocks.lit_redstone_ore, Blocks.quartz_ore, Blocks.redstone_ore})) {
    ...
    public boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        return worldIn.getBlockState((BlockPos)pos).getBlock().blockMaterial.isSolid();
    }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (collidingEntity == Minecraft.thePlayer) {
            EventCollideWithBlock e2 = new EventCollideWithBlock(this, pos, axisalignedbb, state, list);
            EventManager.call(e2);
            axisalignedbb = e2.getBoundingBox();
        }
        EventManager.call(new EventCollideWithBlock(this, pos, mask, state, list));
    ...
    public boolean isCollidable() {
        return !Client.instance.getModuleManager().getModuleByClass(GhostHand.class).isEnabled() || BlockUtils.getBlockID(this) == 54;
    }
    ...
    public static void registerBlocks() {
        ...
        Block.registerBlock(53, "oak_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK)).setUnlocalizedName("stairsWood"));
        ...
        Block.registerBlock(67, "stone_stairs", new BlockStairs(block.defaultBlockState).setUnlocalizedName("stairsStone"));
        ...
        Block.registerBlock(108, "brick_stairs", new BlockStairs(block5.defaultBlockState).setUnlocalizedName("stairsBrick"));
        Block.registerBlock(109, "stone_brick_stairs", new BlockStairs(block8.defaultBlockState.withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.DEFAULT)).setUnlocalizedName("stairsStoneBrickSmooth"));
        ...
        Block.registerBlock(114, "nether_brick_stairs", new BlockStairs(block10.defaultBlockState).setUnlocalizedName("stairsNetherBrick"));
        ...
        Block.registerBlock(128, "sandstone_stairs", new BlockStairs(block2.defaultBlockState.withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH)).setUnlocalizedName("stairsSandStone"));
        ...
        Block.registerBlock(134, "spruce_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE)).setUnlocalizedName("stairsWoodSpruce"));
        Block.registerBlock(135, "birch_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH)).setUnlocalizedName("stairsWoodBirch"));
        Block.registerBlock(136, "jungle_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE)).setUnlocalizedName("stairsWoodJungle"));
        ...
        Block.registerBlock(156, "quartz_stairs", new BlockStairs(block11.defaultBlockState.withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT)).setUnlocalizedName("stairsQuartz"));
        ...
        Block.registerBlock(163, "acacia_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA)).setUnlocalizedName("stairsWoodAcacia"));
        Block.registerBlock(164, "dark_oak_stairs", new BlockStairs(block1.defaultBlockState.withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK)).setUnlocalizedName("stairsWoodDarkOak"));
        ...
        Block.registerBlock(180, "red_sandstone_stairs", new BlockStairs(block12.defaultBlockState.withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.SMOOTH)).setUnlocalizedName("stairsRedSandStone"));
    ...
    public boolean isSolidFullCube() {
        return this.blockMaterial.isSolid() && this.isFullCube();
    }
