...
public class BlockPattern {
    ...
    public static class PatternHelper {
        ...
        public BlockWorldState translateOffset(int palmOffset, int thumbOffset, int fingerOffset) {
            return (BlockWorldState)this.lcache.getUnchecked((Object)BlockPattern.translateOffset(this.pos, this.finger, this.thumb, palmOffset, thumbOffset, fingerOffset));
        }
