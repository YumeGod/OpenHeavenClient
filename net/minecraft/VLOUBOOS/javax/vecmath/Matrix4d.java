...
import net.minecraft.VLOUBOOS.javax.vecmath.AxisAngle4d;
import net.minecraft.VLOUBOOS.javax.vecmath.AxisAngle4f;
import net.minecraft.VLOUBOOS.javax.vecmath.Matrix3d;
import net.minecraft.VLOUBOOS.javax.vecmath.Matrix3f;
import net.minecraft.VLOUBOOS.javax.vecmath.Matrix4f;
import net.minecraft.VLOUBOOS.javax.vecmath.Point3d;
import net.minecraft.VLOUBOOS.javax.vecmath.Point3f;
import net.minecraft.VLOUBOOS.javax.vecmath.Quat4d;
import net.minecraft.VLOUBOOS.javax.vecmath.Quat4f;
import net.minecraft.VLOUBOOS.javax.vecmath.SingularMatrixException;
import net.minecraft.VLOUBOOS.javax.vecmath.Tuple4d;
import net.minecraft.VLOUBOOS.javax.vecmath.Tuple4f;
import net.minecraft.VLOUBOOS.javax.vecmath.VecMathI18N;
import net.minecraft.VLOUBOOS.javax.vecmath.VecMathUtil;
import net.minecraft.VLOUBOOS.javax.vecmath.Vector3d;
import net.minecraft.VLOUBOOS.javax.vecmath.Vector3f;
import net.minecraft.VLOUBOOS.javax.vecmath.Vector4d;
...
Cloneable {
    ...
    static void luBacksubstitution(double[] matrix1, int[] row_perm, double[] matrix2) {
        ...
        for (int k = 0; k < 4; ++k) {
            ...
            matrix2[cv] = (matrix2[cv] - matrix1[(rv -= 4) + 1] * matrix2[cv + 4] - matrix1[rv + 2] * matrix2[cv + 8] - matrix1[rv + 3] * matrix2[cv + 12]) / matrix1[rv];
        }
    }
