...
import net.minecraft.VLOUBOOS.javax.vecmath.Matrix4d;
...
import net.minecraft.VLOUBOOS.javax.vecmath.Vector4f;
...
Cloneable {
    ...
    public boolean epsilonEquals(Matrix4f m1, float epsilon) {
        boolean status;
        boolean bl = status = !(Math.abs(this.m00 - m1.m00) > epsilon);
