...
import net.minecraft.VLOUBOOS.javax.vecmath.GVector;
...
import net.minecraft.VLOUBOOS.javax.vecmath.MismatchedSizeException;
...
Cloneable {
    ...
    public final void getRow(int row, double[] array) {
        if (this.nCol >= 0) {
            System.arraycopy(this.values[row], 0, array, 0, this.nCol);
        }
    }
    ...
    public final void getRow(int row, GVector vector) {
        ...
        if (this.nCol >= 0) {
            System.arraycopy(this.values[row], 0, vector.values, 0, this.nCol);
        }
    }
    ...
    public final void setRow(int row, double[] array) {
        if (this.nCol >= 0) {
            System.arraycopy(array, 0, this.values[row], 0, this.nCol);
        }
    }

    public final void setRow(int row, GVector vector) {
        if (this.nCol >= 0) {
            System.arraycopy(vector.values, 0, this.values[row], 0, this.nCol);
        }
    }
    ...
    public Object clone() {
        ...
        for (int i = 0; i < this.nRow; ++i) {
            if (this.nCol < 0) continue;
            System.arraycopy(this.values[i], 0, m1.values[i], 0, this.nCol);
        }
        return m1;
    }
}
