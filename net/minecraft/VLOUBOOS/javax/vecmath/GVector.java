...
import net.minecraft.VLOUBOOS.javax.vecmath.GMatrix;
...
Cloneable {
    ...
    public final void set(double[] vector) {
        if (this.length - 1 + 1 >= 0) {
            System.arraycopy(vector, 0, this.values, 0, this.length - 1 + 1);
        }
    }
    ...
    public String toString() {
        StringBuffer buffer = new StringBuffer(this.length << 3);
        for (int i = 0; i < this.length; ++i) {
    ...
    public Object clone() {
        ...
        System.arraycopy(this.values, 0, v1.values, 0, this.length);
        return v1;
    }
}
