...
public final class ItemStack {
    ...
    public boolean onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        boolean flag = this.item.onItemUse(this, playerIn, worldIn, pos, side, hitX, hitY, hitZ);
        if (flag) {
    ...
    public float getStrVsBlock(Block blockIn) {
        return this.item.getStrVsBlock(this, blockIn);
    }

    public ItemStack useItemRightClick(World worldIn, EntityPlayer playerIn) {
        return this.item.onItemRightClick(this, worldIn, playerIn);
    }

    public ItemStack onItemUseFinish(World worldIn, EntityPlayer playerIn) {
        return this.item.onItemUseFinish(this, worldIn, playerIn);
    }
    ...
    public boolean isItemStackDamageable() {
        return this.item == null ? false : (this.item.getMaxDamage() <= 0 ? false : !this.hasTagCompound() || !this.stackTagCompound.getBoolean("Unbreakable"));
    }
    ...
    public void onPlayerStoppedUsing(World worldIn, EntityPlayer playerIn, int timeLeft) {
        this.item.onPlayerStoppedUsing(this, worldIn, playerIn, timeLeft);
    }
    ...
    public String getDisplayName() {
        ...
        String s = this.item.getItemStackDisplayName(this);
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.getBoolean("Unbreakable") && (i1 & 4) == 0) {
        ...
        if (advanced) {
            if (this.isItemDamaged()) {
                list.add("Durability: " + (this.getMaxDamage() - this.itemDamage) + " / " + this.getMaxDamage());
            }
            list.add((Object)((Object)EnumChatFormatting.DARK_GRAY) + Item.itemRegistry.getNameForObject(this.item).toString());
            if (this.hasTagCompound()) {
                list.add((Object)((Object)EnumChatFormatting.DARK_GRAY) + "NBT: " + this.stackTagCompound.getKeySet().size() + " tag(s)");
            }
        }
        return list;
    }
    ...
    public boolean isItemEnchantable() {
        return !this.item.isItemTool(this) ? false : !this.isItemEnchanted();
    }
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers() {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("AttributeModifiers", 9)) {
            ...
            multimap = this.item.getItemAttributeModifiers();
        }
        return multimap;
    }
