    ...
    public static void showLagometer(ScaledResolution scaledResolution) {
        if (gameSettings != null && (Lagometer.gameSettings.ofLagometer || Lagometer.gameSettings.showLagometer)) {
            ...
            for (int j = 0; j < timesFrame.length; ++j) {
                ...
                k += 155;
                float f = Minecraft.displayHeight;
                long l = 0L;
                if (gcs[j]) {
            ...
            Lagometer.renderTimeDivider(0, timesFrame.length, 33333333L, 196, 196, 196, Minecraft.displayHeight, worldrenderer);
            Lagometer.renderTimeDivider(0, timesFrame.length, 16666666L, 196, 196, 196, Minecraft.displayHeight, worldrenderer);
            tessellator.draw();
            GlStateManager.enableTexture2D();
            int j2 = Minecraft.displayHeight - 80;
            int k2 = Minecraft.displayHeight - 160;
            Minecraft.fontRendererObj.drawString("30", 2, k2 + 1, -8947849);
            Minecraft.fontRendererObj.drawString("30", 1, k2, -3881788);
            Minecraft.fontRendererObj.drawString("60", 2, j2 + 1, -8947849);
            Minecraft.fontRendererObj.drawString("60", 1, j2, -3881788);
            GlStateManager.matrixMode(5889);
            ...
            int i2 = Minecraft.displayHeight / scaledResolution.getScaleFactor() - 8;
            GuiIngame guiingame = Lagometer.mc.ingameGUI;
            GuiIngame.drawRect(l1 - 1, i2 - 1, l1 + 50, i2 + 10, -1605349296);
            Minecraft.fontRendererObj.drawString(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", l1, i2, k1);
