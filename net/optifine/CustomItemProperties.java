...
public class CustomItemProperties {
    ...
    private static String fixTextureName(String iconName, String basePath) {
        ...
        if (!iconName.isEmpty() && iconName.charAt(0) == '/') {
    ...
    private static String fixModelName(String modelName, String basePath) {
        ...
        if (!modelName.isEmpty() && modelName.charAt(0) == '/') {
    ...
    private NbtTagValue[] parseNbtTagValues(Properties props) {
        ...
        NbtTagValue[] anbttagvalue = list.toArray(new NbtTagValue[0]);
        return anbttagvalue;
    }
    ...
    public void updateIcons(TextureMap textureMap) {
        ...
        if (this.mapTextures != null) {
            ...
            for (Map.Entry<String, String> entry : this.mapTextures.entrySet()) {
    ...
    private static IBakedModel bakeModel(TextureMap textureMap, ModelBlock modelBlockIn, boolean useTint) {
        ...
        for (BlockPart blockpart : modelBlockIn.getElements()) {
            for (Map.Entry<EnumFacing, BlockPartFace> entry : blockpart.mapFaces.entrySet()) {
                ...
                BakedQuad bakedquad = CustomItemProperties.makeBakedQuad(blockpart, blockpartface, textureatlassprite1, entry.getKey(), modelrotation, flag);
    ...
    public void loadModels(ModelBakery modelBakery) {
        ...
        if (this.type == 1 && this.mapModels != null) {
            for (Map.Entry<String, String> entry : this.mapModels.entrySet()) {
                String s1 = entry.getValue();
