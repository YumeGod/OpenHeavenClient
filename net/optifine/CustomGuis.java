...
public class CustomGuis {
    ...
    public static ResourceLocation getTextureLocation(ResourceLocation loc) {
        ...
        if (loc.getResourceDomain().equals("minecraft") && loc.getResourcePath().startsWith("textures/gui/")) {
            ...
            WorldClient iblockaccess = Minecraft.theWorld;
            if (iblockaccess == null) {
                return loc;
            }
            if (guiscreen instanceof GuiContainerCreative) {
                return CustomGuis.getTexturePos(CustomGuiProperties.EnumContainer.CREATIVE, Minecraft.thePlayer.getPosition(), iblockaccess, loc, guiscreen);
            }
            if (guiscreen instanceof GuiInventory) {
                return CustomGuis.getTexturePos(CustomGuiProperties.EnumContainer.INVENTORY, Minecraft.thePlayer.getPosition(), iblockaccess, loc, guiscreen);
            }
