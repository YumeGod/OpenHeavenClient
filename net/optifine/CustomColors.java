...
public class CustomColors {
    ...
    static CustomColormap waterColors = null;
    static CustomColormap foliagePineColors = null;
    static CustomColormap foliageBirchColors = null;
    static CustomColormap swampFoliageColors = null;
    static CustomColormap swampGrassColors = null;
    ...
    private static CustomColormap[] readCustomColormaps(Properties props, String fileName) {
        ...
        CustomColormap[] acustomcolormap = list.toArray(new CustomColormap[0]);
