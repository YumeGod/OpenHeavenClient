...
implements IExpressionFloat {
    ...
    public String toString() {
        return this.type.getIndexNames1() == null ? String.valueOf((Object)this.type) : (this.type.getIndexNames2() == null ? (Object)((Object)this.type) + "." + this.type.getIndexNames1()[this.index1] : (Object)((Object)this.type) + "." + this.type.getIndexNames1()[this.index1] + "." + this.type.getIndexNames2()[this.index2]);
    }
}
