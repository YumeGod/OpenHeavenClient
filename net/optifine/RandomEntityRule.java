...
public class RandomEntityRule {
    ...
    public boolean matches(IRandomEntity randomEntity) {
        ...
        if (this.moonPhases != null) {
            ...
            if (world != null && !this.moonPhases.isInRange(j1 = world.getMoonPhase())) {
                return false;
            }
        }
        if (this.dayTimes != null) {
            int k1;
            Config.getMinecraft();
            WorldClient world1 = Minecraft.theWorld;
            if (world1 != null && !this.dayTimes.isInRange(k1 = (int)world1.getWorldInfo().getWorldTime())) {
                return false;
            }
        }
        if (this.weatherList != null) {
            Weather weather;
            Config.getMinecraft();
            WorldClient world2 = Minecraft.theWorld;
            if (world2 != null && !ArrayUtils.contains((Object[])this.weatherList, (Object)(weather = Weather.getWeather(world2, 0.0f)))) {
                return false;
            }
        }
        return true;
