...
Cloneable {
    ...
    public final void clamp(double min, double max, Tuple4d t) {
        this.x = t.x > max ? max : Math.max(t.x, min);
        this.y = t.y > max ? max : Math.max(t.y, min);
        this.z = t.z > max ? max : Math.max(t.z, min);
        this.w = t.w > max ? max : Math.max(t.w, min);
    }
    ...
    public final void clampMin(double min, Tuple4d t) {
        this.x = Math.max(t.x, min);
        this.y = Math.max(t.y, min);
        this.z = Math.max(t.z, min);
        this.w = Math.max(t.w, min);
    }
    ...
    public final void clampMax(double max, Tuple4d t) {
        this.x = Math.min(t.x, max);
        this.y = Math.min(t.y, max);
        this.z = Math.min(t.z, max);
