...
extends GuiButton {
    ...
    public FlatButtonNoBold(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        this.GotAlpha();
        this.x2 = AnimationUtil.moveUD(this.x2, this.hovered ? 40.0f : 0.0f, 0.2f, 0.15f);
        Client.instance.FontLoaders.Comfortaa45.drawString(this.displayString, (float)(this.xPosition + this.width / 2) + this.x2 - (float)(Client.instance.FontLoaders.bold50.getStringWidth(this.displayString) / 2), (float)this.yPosition + (float)(this.height - 6) / 2.0f, this.RectColor());
    }
