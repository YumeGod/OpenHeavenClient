...
public class TabGUI {
    ...
    public void onKey(EventKey e) {
        block16: {
            block17: {
                if (!HUD.tabguimode.is("Normal")) break block16;
    ...
    private void updateBars() {
        if (HUD.tabguimode.is("Normal") && Client.instance.getModuleManager().getModuleByClass(HUD.class).isEnabled() && ((Boolean)HUD.tabgui.getValue()).booleanValue()) {
    ...
    public void renderTabGui() {
        ...
        if (HUD.tabguimode.is("Normal") && Client.instance.getModuleManager().getModuleByClass(HUD.class).isEnabled() && ((Boolean)HUD.tabgui.getValue()).booleanValue()) {
            ...
            if (((Boolean)HUD.Breathinglamp.getValue()).booleanValue()) {
                if (((Boolean)HUD.rainbow.getValue()).booleanValue()) {
                    RenderUtil.drawGradientSideways(5.0, this.categoryPosition - 1.0f + this.shouldY, 70.0, this.categoryPosition + 11.0f + this.shouldY, HUD.rainbowmode.is("Client") ? color332.getRGB() : color33.getRGB(), HUD.rainbowmode.is("Client") ? color333.getRGB() : color332.getRGB());
                } else {
                    ...
                    RenderUtil.drawRect(5.0, (double)(this.categoryPosition - 1.0f + this.shouldY), 70.0, (double)(this.categoryPosition + 11.0f + this.shouldY + 0.1f), Ranbow.getRGB());
                }
            } else if (((Boolean)HUD.rainbow.getValue()).booleanValue()) {
                RenderUtil.drawGradientSideways(5.0, this.categoryPosition - 1.0f + this.shouldY, 70.0, this.categoryPosition + 11.0f + this.shouldY, HUD.rainbowmode.is("Client") ? color332.getRGB() : color33.getRGB(), HUD.rainbowmode.is("Client") ? color333.getRGB() : color332.getRGB());
            } else {
                RenderUtil.drawGradientSideways(5.0, this.categoryPosition - 1.0f + this.shouldY, 70.0, this.categoryPosition + 11.0f + this.shouldY, this.HUDColor(), this.HUDColor());
            }
            float yPos = 21.0f;
            ...
            if (this.section == Section.MODS || this.modulesXanim >= 2.5f) {
                ...
                RenderUtil.drawGradientSideways((double)this.baseCategoryWidth - 0.5 + (double)this.modulesXanim, this.categoryPosition - 1.0f + 1.0f + this.shouldY - 1.0f, this.baseCategoryWidth + 2.0f - 16.0f + 79.0f + this.modulesXanim + 2.0f + 5.0f + 3.0f, this.categoryPosition + (float)(size * 12) - 1.0f + this.shouldY, new Color(15, 15, 15, this.alpha).getRGB(), new Color(15, 15, 15, this.alpha).getRGB());
                if (((Boolean)HUD.rainbow.getValue()).booleanValue()) {
                    RenderUtil.drawGradientSideways((double)this.baseCategoryWidth - 0.5 + (double)this.modulesXanim, this.modPosition + this.shouldY - 1.0f, this.baseCategoryWidth + 8.0f + 57.0f + this.modulesXanim + 2.0f + 5.0f + 3.0f, this.modPosition + 9.0f + this.shouldY + 2.0f, HUD.rainbowmode.is("Client") ? color332.getRGB() : color33.getRGB(), HUD.rainbowmode.is("Client") ? color333.getRGB() : color332.getRGB());
                } else {
                    RenderUtil.drawGradientSideways((double)this.baseCategoryWidth - 0.5 + (double)this.modulesXanim, this.modPosition + this.shouldY - 1.0f, this.baseCategoryWidth + 8.0f + 57.0f + this.modulesXanim + 2.0f + 5.0f + 3.0f, this.modPosition + 9.0f + this.shouldY + 2.0f, this.HUDColorOnlyMobs(), this.HUDColorOnlyMobs());
                }
