...
extends Module {
    ...
    public StaffDetector() {
        super("StaffDetector", ModuleType.Misc);
    }

    @Override
    public void onEnable() {
        Helper.sendMessage("Warning - Only check blockmc staff.");
    }
    ...
    public void onTick(EventTick e) {
        this.setSuffix((Serializable)((Object)"BlockMC"));
        if (Minecraft.thePlayer.ticksExisted > 5) {
            for (EntityPlayer player : Minecraft.theWorld.playerEntities) {
                ...
                for (String staff : this.verusKnownStaff) {
                    ...
                    Helper.addChat(staff + " \u00a7fis in your game!");
                }
            }
        } else {
            this.staffInMatch.clear();
